...
(function () {
    ...
    function G(a, b, c) {
        var d, e;
        if (Ca(b))t(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (t(b) &&
            fa(b))for (d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    function $(a, b, c, d, e) {
        a = y.createElement(a);
        b && q(a, b);
        e && D(a, {padding: 0, border: S, margin: 0});
        c && D(a, c);
        d && d.appendChild(a);
        return a
    }
    ...
    function oa(a,
                b, c, d) {
        var e = K.numberFormat, f = J.lang, g = +a || 0, h = b === -1 ? (g.toString().split(".")[1] || "").length : isNaN(b = U(b)) ? 2 : b, i = c === void 0 ? f.decimalPoint : c, f = d === void 0 ? f.thousandsSep : d, j = g < 0 ? "-" : "", k = String(B(g = U(g).toFixed(h))), l = k.length > 3 ? k.length % 3 : 0;
    ...
    function qb() {
        var a = J.global.useUTC, b = a ? "getUTC" : "get";
    ...
    var r, y = document, I = window, F = Math, w = F.round, ea = F.floor, Ha = F.ceil, s = F.max, R = F.min, U = F.abs, qa = F.cos, va = F.sin, hb = F.PI, Aa = hb * 2 / 360, wa = navigator.userAgent, zb = I.opera, za = /msie/i.test(wa) && !zb, cb = y.documentMode === 8, ib = /AppleWebKit/.test(wa), Ma = /Firefox/.test(wa), Ab = /(Mobile|Android|Windows Phone)/.test(wa), xa = "http://www.w3.org/2000/svg", ca = !!y.createElementNS && !!y.createElementNS(xa, "svg").createSVGRect, Hb = Ma && parseInt(wa.split("Firefox/")[1], 10) < 4, ga = !ca && !za && !!y.createElement("canvas").getContext, Na, Ra, Bb = {}, jb = 0, bb, J, $a, ha, kb, Oa, ja, aa = function () {
        return r
    }, V = [], Sa = 0, Ga = "div", S = "none", Ib = /^[0-9]+$/, Jb = "stroke-width", Ka, rb, sb, tb, ub, vb, wb, xb, u = {}, K;
    I.Highcharts ? ja(16, !0) : K = I.Highcharts =
    {};
    $a = function (a, b, c) {
        if (!t(b) || isNaN(b))return "Invalid date";
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new Ka(b - rb), e, f = d[tb](), g = d[ub](), h = d[vb](), i = d[wb](), j = d[xb](), k = J.lang, l = k.weekdays, d = q({
            a: l[g].substr(0, 3),
            A: l[g],
            d: Ea(h),
            e: h,
    ...
    var ra = I.HighchartsAdapter, P = ra || {};
    ra && ra.init.call(ra, kb);
    var db = P.adapterRun, Kb = P.getScript, Ta = P.inArray, o = P.each, Cb = P.grep, Lb =
        P.offset, Ua = P.map, N = P.addEvent, Y = P.removeEvent, C = P.fireEvent, Mb = P.washMouseEvent, eb = P.animate, Va = P.stop, P = {
        enabled: !0,
        x: 0,
        y: 15,
    ...
    var W = J.plotOptions, ra = W.line;
    qb();
    var Nb = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, Ob = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/, Pb = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/,
        Z = function (a) {
            var b = [], c, d;
            (function (a) {
    ...
    H.prototype = {
        ...
        colorGradient: function (a, b, c) {
            var d = this.renderer, e, f, g, h, i, j, k, l, n, m, x = [];
        ...
        attr: function (a, b) {
            ...
            if (typeof a ===
                "string")g = (this[a + "Getter"] || this._defaultGetter).call(this, a, e); else {
                for (c in a) {
                    d = a[c];
                    h = !1;
        ...
        css: function (a) {
            ...
            if (e) {
                ...
                if (za && !ca)D(this.element, a); else {
                    b = function (a, b) {
        ...
        on: function (a, b) {
            ...
            Ra && a === "click" ? (d.ontouchstart = function (a) {
                ...
                (wa.indexOf("Android") === -1 || Ka.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a)
            }) : d["on" + a] = b;
            return this
        },
        ...
        getBBox: function () {
            var a = this.bBox, b = this.renderer,
                c, d, e = this.rotation;
            c = this.element;
            var f = this.styles, g = e * Aa;
            d = this.textStr;
            var h;
        ...
        add: function (a) {
            var b = this.renderer, c = a || b, d = c.element || b.box, e = this.element, f = this.zIndex,
                g, h;
            ...
            if (c.handleZ) {
                a = d.childNodes;
                for (g = 0; g < a.length; g++)if (b = a[g], c = G(b, "zIndex"), b !== e && (B(c) > f || !t(f) && t(c))) {
                    d.insertBefore(e, b);
                    h = !0;
                    break
                }
        ...
        destroy: function () {
            var a = this, b = a.element || {}, c = a.shadows, d = a.renderer.isSVG && b.nodeName ===
                "SPAN" && a.parentGroup, e, f;
    ...
    H.prototype["stroke-widthSetter"] = H.prototype.strokeSetter = function (a, b, c) {
        this[b] = a;
        if (this.stroke && this["stroke-width"])this.strokeWidth = this["stroke-width"], H.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0; else if (b === "stroke-width" && a ===
    ...
    ba.prototype = {
        Element: H, init: function (a, b, c, d, e) {
            ...
            !f && !m && e.indexOf(" ") === -1 ? b.appendChild(y.createTextNode(e)) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, l && !a.added && this.box.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g,
                ...
                o(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        var m = {}, x = y.createElementNS(xa, "tspan"), p;
                        ...
                        if (e !== " ") {
                            ...
                            if (n)m.dx = 0; else if (f && j !== null)m.x = j;
                            G(x, m);
                            b.appendChild(x);
                            !n && f && (!ca && d && D(x, {display: "block"}), G(x, "dy", M(x)));
                            if (l)for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), m = g.length > 1 || e.length > 1 && k.whiteSpace !== "nowrap", o, z, r = k.HcHeight, q = [], t = M(x), Db = 1; m && (e.length || q.length);)delete a.bBox, o = a.getBBox(), z = o.width, !ca && c.forExport && (z = c.measureSpanWidth(x.firstChild.data,
            ...
            var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, l, n, m, x, p, o, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            m = e.style;
            delete e.style;
            f = v(e, {stroke: "#68A", fill: {linearGradient: a, stops: [[0, "#FFF"], [1, "#ACF"]]}}, f);
            x = f.style;
            delete f.style;
            g = v(e, {stroke: "#68A", fill: {linearGradient: a, stops: [[0, "#9BD"], [1, "#CDF"]]}}, g);
            p = g.style;
            delete g.style;
            h = v(e, {style: {color: "#CCC"}}, h);
            o = h.style;
            delete h.style;
            ...
            }, j = a.match(i)[1], a = Bb[j] || f && f.width && f.height &&
            [f.width, f.height], g = this.image(j).attr({x: b, y: c}), g.isImg = !0, a ? k(g, a) : (g.attr({
                width: 0,
                height: 0
            }), $("img", {
                onload: function () {
            ...
            circle: function (a, b, c, d) {
                ...
                var f = e.start, c = e.r || c || d, g = e.end - 0.001, d = e.innerR, h = e.open, i = qa(f), j = va(f), k = qa(g), g = va(g), e = e.end - f < hb ? 0 : 1;
                return ["M", a + c * i, b + c * j, "A", c, c, 0, e, 1, a + c * k, b + c * g, h ? "M" : "L", a + d * k, b + d * g, "A", d, d, 0, e, 0, a + d * i, b + d * j, h ? "" : "Z"]
            }, callout: function (a, b, c, d, e) {
                var f = R(e && e.r || 0, c, d), g = f + 6, h = e && e.anchorX, i = e && e.anchorY, e = w(e.strokeWidth || 0) % 2 / 2;
                a += e;
                b += e;
            ...
            var a = /px/.test(a) ? B(a) : /em/.test(a) ? parseFloat(a) * 12 : 12, c = a < 24 ? a + 4 : w(a * 1.2), d = w(c * 0.8);
            return {h: c, b: d, f: a}
            ...
            function j() {
                ...
                if (mb) {
                    ...
                    p.isImg || p.attr(q({width: w(m.width), height: w(m.height)}, A));
                    A = null
                }
            }

            function k() {
                var a = m.styles, a = a && a.textAlign, b = fb + E * (1 - O), c;
                c = h ? 0 : Ba;
                if (t(s) && z && (a === "center" || a === "right"))b += {center: 0.5, right: 1}[a] * (s - z.width);
            ...
            var n = this, m = n.g(i), x = n.text("", 0, 0, g).attr({zIndex: 1}), p, z, O = 0, E = 3, fb = 0, s, u, lb, y, B = 0, A = {}, Ba, mb;
            m.onAdd = function () {
                x.add(m);
                m.attr({text: a || a === 0 ? a : "", x: b, y: c});
                p && t(e) && m.attr({anchorX: e, anchorY: f})
            };
            ...
            return q(m, {
                css: function (a) {
                    ...
                    return {
                        width: z.width + 2 * E, height: z.height + 2 * E, x: z.x - E, y: z.y -
                        E
                    }
                }, shadow: function (a) {
                    p && p.shadow(a);
    ...
    q(H.prototype, {
        htmlCss: function (a) {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    var j =
                        this.rotation, k, l = B(this.textWidth), n = [j, g, b.innerHTML, this.textWidth].join(",");
                    if (n !== this.cTT) {
                ...
                if (this.parentGroup = a) {
                    if (b = a.div, !b) {
                        ...
                        o(j.reverse(), function (a) {
                            var d;
                            b = a.div = a.div || $(Ga, {className: G(a.element, "class")}, {
    ...
    if (!ca && !ga)L = {
        init: function (a, b) {
            ...
            var a = this.rotation, b = qa(a *
            Aa), c = va(a * Aa);
            D(this.element, {filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"].join("") : S})
        }, getSpanCorrection: function (a, b, c, d, e) {
            var f = d ? qa(d * Aa) : 1, g = d ? va(d * Aa) : 0, h = p(this.elemHeight, this.element.offsetHeight), i;
            this.xCorr = f < 0 && -a;
            this.yCorr = g < 0 && -h;
            i = f * g < 0;
        ...
        pathToVML: function (a) {
            for (var b = a.length, c = []; b--;)if (ka(a[b]))c[b] = w(a[b] * 10) - 5; else if (a[b] === "Z")c[b] = "x"; else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at"))c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1), c[b + 6] === c[b + 8] && (c[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1);
            return c.join(" ") || "x"
        }, clip: function (a) {
            var b = this, c;
        ...
        safeRemoveChild: function (a) {
            ...
            var d = [], e, f = this.element, g = this.renderer, h, i = f.style, j, k = f.path, l, n, m, x;
            ...
            if (a) {
                ...
                for (e = 1; e <= 3; e++) {
                    ...
                    h = $(g.prepVML(j), null, {left: B(i.left) + p(a.offsetX, 1), top: B(i.top) + p(a.offsetY, 1)});
                    if (c)h.cutOff = l + 1;
            ...
            return this
        }, updateShadows: aa, setAttr: function (a, b) {
            ...
            var d = c.nodeName;
            if (d === "SPAN")c.style.color = a; else if (d !== "IMG")c.filled = a !== S, this.setAttr("fillcolor", this.renderer.color(a, c, b, this))
        }, opacitySetter: aa, rotationSetter: function (a, b, c) {
            c = c.style;
            this[b] = c[b] = a;
        ...
        Element: L, isIE8: wa.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
            var e;
            this.alignedObjects = [];
            d = this.createElement(Ga).css(q(this.getStyle(d), {position: "relative"}));
            e = d.element;
            ...
            return q(e, {
                ...
                getCSS: function (a) {
                    ...
                    !a && cb && c === "DIV" && q(d, {width: b + "px", height: f + "px"});
                    return d
                },
            ...
            if (i) {
                var k, l, n = a.linearGradient || a.radialGradient, m, p, M, z, O, E = "", a = a.stops, r, q = [], s = function () {
                ...
                if (c === "fill")if (i === "gradient")c = n.x1 || n[0] || 0, a = n.y1 || n[1] || 0, m = n.x2 || n[2] || 0, n = n.y2 || n[3] || 0, E = 'angle="' + (90 - F.atan((n - a) / (m - c)) * 180 / hb) + '"', s(); else {
                    var j = n.r, t = j * 2, w = j * 2, u = n.cx, A = n.cy, v = b.radialReference, y, j = function () {
            ...
            } else if (g.test(a) && b.tagName !== "IMG")f = Z(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], $(this.prepVML(h), null, null, b), j = f.get("rgb"); else {
            ...
            arc: function (a, b, c, d, e) {
                var f = e.start, g = e.end, h = e.r || c || d, c = e.innerR, d = qa(f), i = va(f), j = qa(g), k = va(g);
                if (g - f === 0)return ["x"];
    ...
    La.prototype = {
        addLabel: function () {
            var a = this.axis, b = a.options, c = a.chart, d = a.horiz, e = a.categories, f = a.names, g = this.pos, h = b.labels, i = h.rotation, j = a.tickPositions, d = d && e && !h.step && !h.staggerLines && !h.rotation && c.plotWidth / j.length || !d && (c.margin[3] || c.chartWidth * 0.33), k = g === j[0], l = g === j[j.length - 1], n, f = e ? p(e[g], f[g], g) : g, e = this.label, m = j.info;
            a.isDatetimeAxis &&
            ...
            var c = !0, d = this.axis, e = this.isFirst, f = this.isLast, g = d.horiz ?
                b.x : b.y, h = d.reversed, i = d.tickPositions, j = this.getLabelSides(), k = j[0], j = j[1], l, n, m, p = this.label.line;
            l = p || 0;
            n = d.labelEdge;
            ...
            var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type, i = this.label, j = this.pos, k = e.labels, l = this.gridLine, n = h ? h + "Grid" : "grid", m = h ? h + "Tick" : "tick", x = e[n + "LineWidth"], o = e[n + "LineColor"], z = e[n + "LineDashStyle"], O = e[m + "Length"], n = e[m + "Width"] || 0, E = e[m + "Color"], q = e[m + "Position"], m = this.mark, s = k.step, t = !0, w = d.tickmarkOffset, u = this.getPosition(g, j, w, b), v = u.x,
                u = u.y, A = g && v === d.pos + d.len || !g && u === d.pos ? -1 : 1, c = p(c, 1);
            this.isActive = !0;
            if (x) {
                j = d.getPlotLinePath(j + w, x * A, b, !0);
                if (l === r) {
                    l = {stroke: o, "stroke-width": x};
                    if (z)l.dashstyle = z;
                    if (!h)l.zIndex = 1;
                    if (b)l.opacity = 0;
            ...
            if (n && O)q === "inside" && (O = -O), d.opposite && (O = -O), h = this.getMarkPath(v, u, O, n * A, g, f), m ? m.animate({
                d: h,
                opacity: c
            }) : this.mark = f.path(h).attr({stroke: E, "stroke-width": n, opacity: c}).add(d.axisGroup);
    ...
    Q.prototype = {
        ...
        setOptions: function (a) {
            this.options = v(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions,
                this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], v(J[this.coll], a))
        },
        defaultLabelFormatter: function () {
            var a = this.axis, b = this.value, c = a.categories, d = this.dateTimeLabelFormat, e = J.lang.numericSymbols, f = e && e.length, g, h = a.options.labels.format, a = a.isLog ? b : a.tickInterval;
            if (h)g = Ia(h, this); else if (c)g = b; else if (d)g = $a(d, b); else if (f && a >= 1E3)for (; f-- && g === r;)c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = oa(b / c, -1) + e[f]);
        ...
        getLinearTickPositions: function (a, b, c) {
            var d, e = ua(ea(b / a) * a), f = ua(Ha(c / a) * a), g = [];
        ...
        setAxisTranslation: function (a) {
            var b = this, c = b.max - b.min, d = b.axisPointRange || 0, e, f = 0, g = 0, h = b.linkedParent, i = !!b.categories,
                j = b.transA;
        ...
        setTickPositions: function (a) {
            var b = this, c = b.chart, d = b.options, e = d.startOnTick, f = d.endOnTick, g = b.isLog, h = b.isDatetimeAxis, i = b.isXAxis, j = b.isLinked, k = b.options.tickPositioner, l = d.maxPadding, n = d.minPadding, m = d.tickInterval, x = d.minTickInterval, M = d.tickPixelInterval, z, O = b.categories;
        ...
        setExtremes: function (a, b, c, d, e) {
            var f = this, g = f.chart, c = p(c, !0), e = q(e, {min: a, max: b});
        ...
        setAxisSize: function () {
            var a = this.chart,
                b = this.options, c = b.offsetLeft || 0, d = this.horiz, e = p(b.width, a.plotWidth - c + (b.offsetRight || 0)), f = p(b.height, a.plotHeight), g = p(b.top, a.plotTop), b = p(b.left, a.plotLeft + c), c = /%$/;
        ...
        getOffset: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i =
                b.inverted ? [1, 0, 3, 2][h] : h, j, k, l = 0, n, m = 0, x = d.title, M = d.labels, z = 0, O = b.axisOffset, b = b.clipOffset, E = [-1, 1, 1, -1][h], q, w = 1, u = p(M.maxStaggerLines, 5), v, y, B, A, Ba;
            a.hasData = j = a.hasVisibleSeries || t(a.min) && t(a.max) && !!e;
            a.showAxis = k = j || p(d.showEmpty, !0);
            a.staggerLines = a.horiz && M.staggerLines;
            if (!a.axisGroup)a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(), a.labelGroup = c.g("axis-labels").attr({zIndex: M.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() +
            "-labels").add();
            if (j || a.isLinked) {
                ...
                o(e, function (b) {
                    if (h === 0 || h === 2 || {1: "left", 3: "right"}[h] === a.labelAlign)z =
            ...
            if (x && x.text && x.enabled !== !1) {
                if (!a.axisTitle)a.axisTitle = c.text(x.text, 0, 0, x.useHTML).attr({
                    ...
                    align: x.textAlign || {low: "left", middle: "center", high: "right"}[x.align]
        ...
        render: function () {
            var a = this, b = a.horiz, c = a.reversed, d = a.chart, e = d.renderer, f = a.options,
                g = a.isLog, h = a.isLinked, i = a.tickPositions, j, k = a.axisTitle, l = a.ticks, n = a.minorTicks, m = a.alternateBands, p = f.stackLabels, M = f.alternateGridColor, z = a.tickmarkOffset, O = f.lineWidth, E = d.hasRendered && t(a.oldMin) && !isNaN(a.oldMin), q = a.hasData, s = a.showAxis, w, u = f.labels.overflow, v = a.justifyLabels = b && u !== !1, y;
            a.labelEdge.length = 0;
            a.justifyToPlot = u === "justify";
            o([l, n, m], function (a) {
                for (var b in a)a[b].isActive = !1
            });
            if (q || h)if (a.minorTickInterval && !a.categories && o(a.getMinorTickPositions(), function (b) {
                    n[b] || (n[b] =
                        new La(a, b, "minor"));
                    ...
                    {from: g ? la(w) : w, to: g ? la(y) : y, color: M}, m[b].render(), m[b].isActive = !0
                }), !a._addedPlotLB)o((f.plotLines || []).concat(f.plotBands || []), function (b) {
                a.addPlotBandOrLine(b)
            }), a._addedPlotLB = !0;
            o([l, n, m], function (a) {
                var b, c, e = [], f = ha ? ha.duration || 500 : 0, g = function () {
        ...
        drawCrosshair: function (a, b) {
            if (this.crosshair)if ((t(b) || !p(this.crosshair.snap, !0)) === !1)this.hideCrosshair(); else {
    ...
    Q.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5)a = w(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = ea(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
            i = e.length;
            for (h = 0; h < i && !l; h++)j = Pa(la(f) * e[h]), j > b && (!d || k <= c) && k !== r && g.push(k), k > c && (l = !0), k = j
        } else if (b = la(b), c = la(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval,
                (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = pb(a, null, F.pow(10, ea(F.log(a) / F.LN10))), g = Ua(this.getLinearTickPositions(a, b, c), Pa), !d)this._minorAutoInterval = a / 5;
    ...
    Fb.prototype = {
        init: function (a, b) {
            ...
            var e = this, f = e.now, g = e.options.animation !== !1 && !e.isHidden && (U(a - f.x) > 1 || U(b - f.y) > 1), h = e.followPointer || e.len > 1;
            q(f, {
                x: g ? (2 * f.x + a) /
                3 : a,
                y: g ? (f.y + b) / 2 : b,
            ...
            var c,
                d = this.chart, e = d.inverted, f = d.plotTop, g = 0, h = 0, i, a = na(a);
            c = a[0].tooltipPos;
            ...
            var d = this.chart, e = this.distance, f = {}, g, h = ["y", d.chartHeight,
                b, c.plotY + d.plotTop], i = ["x", d.chartWidth, a, c.plotX + d.plotLeft], j = c.ttBelow || d.inverted && !c.negative || !d.inverted && c.negative, k = function (a, b, c, d) {
            ...
            i === !1 ? this.hide() : (this.isHidden && (Va(d), d.attr("opacity", 1).show()), d.attr({text: i}), k = e.borderColor ||
            a.color || h.color || "#606060", d.attr({stroke: k}), this.updatePosition({
                plotX: f,
                plotY: g,
                negative: a.negative,
                ttBelow: a.ttBelow
            }), this.isHidden = !1);
            C(c, "tooltipRefresh", {text: i, x: f + c.plotLeft, y: g + c.plotTop, borderColor: k})
            ...
            var b = a.series, c = b.tooltipOptions, d = c.dateTimeLabelFormats,
                e = c.xDateFormat, f = b.xAxis, g = f && f.options.type === "datetime" && ka(a.key), c = c.headerFormat, f = f && f.closestPointRange, h;
            if (g && !e) {
                if (f)for (h in Oa) {
    ...
    ya.prototype = {
        init: function (a, b) {
            ...
            return q(a, {chartX: w(c), chartY: w(d)})
            ...
            var b = this.chart, c = b.series, d = b.tooltip,
                e, f, g = b.hoverPoint, h = b.hoverSeries, i, j, k = b.chartWidth, l = this.getIndex(a);
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                f = [];
                i = c.length;
                for (j = 0; j < i; j++)if (c[j].visible && c[j].options.enableMouseTracking !== !1 && !c[j].noSharedTooltip && c[j].singularTooltips !== !0 && c[j].tooltipPoints.length && (e = c[j].tooltipPoints[l]) && e.series)e._dist = U(l - e.clientX), k = R(k, e._dist), f.push(e);
            ...
            var c = this.chart, d = c.hoverSeries, e = c.hoverPoint, f = c.tooltip, g = f && f.shared ? c.hoverPoints :
                e;
            ...
            var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop, j = b.plotWidth, k = b.plotHeight, l, n = this.mouseDownX, m = this.mouseDownY, p = c.panKey && a[c.panKey + "Key"];
            d < h ? d = h : d > h + j && (d = h + j);
            e < i ? e = i : e > i + k && (e = i + k);
            ...
            if (this.hasDragged > 10) {
                ...
                this.selectionMarker && f && (d -= n, this.selectionMarker.attr({width: U(d), x: (d > 0 ? 0 : d) + n}));
            ...
            if (this.selectionMarker) {
                ...
                if (this.hasDragged || c)o(b.axes, function (b) {
                    if (b.zoomEnabled) {
                        var c = b.horiz, e = a.type === "touchend" ? b.minPixelPadding : 0, m = b.toValue((c ? f : g) + e), c = b.toValue((c ?
                        f + h : g + i) - e);
                        !isNaN(m) && !isNaN(c) && (d[b.coll].push({axis: b, min: R(m, c), max: s(m, c)}), j = !0)
                    }
            ...
            for (var c; a;) {
                if (c = G(a, "class"))if (c.indexOf(b) !== -1)return !0; else if (c.indexOf("highcharts-container") !== -1)return !1;
                a = a.parentNode
            }
            ...
            var b =
                this.chart, c = b.hoverPoint, d = b.plotLeft, e = b.plotTop, a = this.normalize(a);
            a.cancelBubble = !0;
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (C(c.series, "click", q(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (q(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && C(b, "click", a)))
    ...
    q(K.Pointer.prototype,
        {
            ...
            var i = this.chart, j = a ? "x" : "y", k = a ? "X" : "Y", l = "chart" + k, n = a ? "width" : "height", m = i["plot" + (a ? "Left" : "Top")], p, o, z = h || 1, q = i.inverted, E = i.bounds[a ? "h" : "v"], r = b.length === 1, s = b[0][l], t = c[0][l], w = !r && b[1][l], u = !r && c[1][l], v, c = function () {
            ...
            var b = this, c = b.chart, d = b.pinchDown, e = b.followTouchMove, f = a.touches, g = f.length, h = b.lastValidTouch, i = b.hasZoom, j = b.selectionMarker, k = {}, l = g === 1 && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick ||
                b.runChartClick), n = {};
            ...
            if (a.type === "touchstart")o(f, function (a, b) {
                ...
                if (a.zoomEnabled) {
                    var b = c.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding, e = a.toPixels(p(a.options.min, a.dataMin)), f = a.toPixels(p(a.options.max, a.dataMax)), g = R(e, f), e = s(e, f);
                    b.min = R(a.pos, g - d);
                    b.max = s(a.pos + a.len, e + d)
                }
            }), b.res = !0; else if (d.length) {
                if (!j)b.selectionMarker =
                    j = q({destroy: aa}, c.plotBox);
    ...
    if (I.PointerEvent || I.MSPointerEvent) {
        var sa = {}, nb = !!I.PointerEvent, Qb = function () {
            var a, b = [];
            b.item = function (a) {
                return this[a]
            };
            for (a in sa)sa.hasOwnProperty(a) && b.push({pageX: sa[a].pageX, pageY: sa[a].pageY, target: sa[a].target});
            return b
        }, ob = function (a, b, c, d) {
            a = a.originalEvent || a;
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && V[ma])d(a), d = V[ma].pointer, d[b]({
                type: c, target: a.currentTarget, preventDefault: aa,
                touches: Qb()
            })
        };
        q(ya.prototype, {
            onContainerPointerDown: function (a) {
                ob(a, "onContainerTouchStart", "touchstart", function (a) {
                    sa[a.pointerId] = {pageX: a.pageX, pageY: a.pageY, target: a.currentTarget}
                })
            }, onContainerPointerMove: function (a) {
                ob(a, "onContainerTouchMove", "touchmove", function (a) {
                    sa[a.pointerId] = {pageX: a.pageX, pageY: a.pageY};
        ...
        X(ya.prototype, "init", function (a, b, c) {
            a.call(this, b, c);
            (this.hasZoom || this.followTouchMove) && D(b.container, {"-ms-touch-action": S, "touch-action": S})
        });
    ...
    Xa.prototype = {
        init: function (a, b) {
            ...
            var b = this.chart, c = b.renderer, d = this.options, e = d.layout === "horizontal", f = this.symbolWidth, g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle, j = this.padding, k = e ? p(d.itemDistance, 20) : 0, l = !d.rtl, n = d.width, m = d.itemMarginBottom || 0, o = this.itemMarginTop, M = this.initialItemX, z = a.legendItem, q = a.series && a.series.drawLegendSymbol ? a.series : a, E = q.options, E = this.createCheckboxForItem && E && E.showCheckbox, r = d.useHTML;
            if (!z) {
            ...
            var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g = e.maxHeight, h, i = this.clipRect, j = e.navigation, k = p(j.animation, !0), l = j.arrowSize || 12, n = this.nav, m = this.pages, x, M = this.allItems;
            ...
            if (e > 0)b !== r && (ha = p(b, this.chart.animation)), this.nav.attr({
                ...
                fill: e === d ? g : h
            }).css({cursor: e === d ? "default" : "pointer"}), c = -c[e - 1] + this.initialItemY, this.scrollGroup.animate({translateY: c}), this.currentPage = e,
    ...
    pa.prototype = {
        init: function (a, b) {
            ...
            var b = this.axes, c = this.series, d = this.pointer, e = this.legend, f = this.isDirtyLegend, g, h, i = this.hasCartesianSeries, j = this.isDirtyBox, k = c.length, l = k, n = this.renderer, m = n.isHidden(),
                x = [];
            ...
            if (c && (c.css({width: (f.width || h) + "px"}).align(q({y: g.fontMetrics(f.style.fontSize, c).b - 3}, f), !1, "spacingBox"), !f.floating && !f.verticalAlign))b = c.getBBox().height;
            d && (d.css({width: (e.width || h) + "px"}).align(q({
                y: b +
        ...
        getContainer: function () {
            ...
            var b = this, c = b.options.chart, d = b.renderTo, e = c.width || db(d, "width"), f = c.height || db(d, "height"), c = a ? a.target : I, d = function () {
            ...
            (ha ? eb : D)(d.container, {width: e + "px", height: f + "px"}, ha);
            d.setChartSize(!0);
            ...
            var b = this.inverted,
                c = this.renderer, d = this.chartWidth, e = this.chartHeight, f = this.options.chart, g = this.spacing, h = this.clipOffset, i, j, k, l;
            ...
            if (k)f ? f.animate(s) : this.plotBackground = b.rect(p, o, q, r, 0).attr({fill: k}).add().shadow(a.plotShadow);
            ...
            if (n)g ? g.animate(g.crisp({
                ...
                stroke: a.plotBorderColor, "stroke-width": n, fill: S,
                zIndex: 1
            }).add();
            this.isDirtyBox = !1
            ...
            b.items && o(b.items, function (c) {
                var d = q(b.style, c.style), e = B(d.left) + a.plotLeft, f = B(d.top) + a.plotTop + 12;
                delete d.left;
                delete d.top;
    ...
    ia.prototype = {
        init: function (a, b, c) {
            ...
            if (typeof a === "number" || a === null)b[d[0]] = a; else if (Da(a)) {
                if (a.length > e) {
                    c = typeof a[0];
    ...
    T.prototype = {
        ...
        setData: function (a, b, c, d) {
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, j = e.chart, k = null, l = e.xAxis,
                n = l && !!l.categories, m = e.tooltipPoints, x = i.turboThreshold, q = this.xData, z = this.yData, s = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = p(b, !0);
                ...
                if (x && h > x) {
                    ...
                    if (ka(k)) {
                        ...
                        for (c = 0; c < h; c++)q[c] = n, z[c] = a[c], n +=
                            i;
                        e.xIncrement = n
                    } else if (Da(k))if (s)for (c = 0; c < h; c++)i = a[c], q[c] = i[0], z[c] = i.slice(1, s + 1); else for (c = 0; c < h; c++)i = a[c], q[c] = i[0], z[c] = i[1]; else ja(12)
                } else for (c = 0; c < h; c++)if (a[c] !== r && (i = {series: e}, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i, c), n && i.name))l.names[i.x] = i.name;
                Ca(z[0]) && ja(14, !0);
                e.data = [];
                e.options.data = a;
        ...
        processData: function (a) {
            ...
            if (l && this.sorted && (!i || d > i || this.forceCrop))if (b[d - 1] < m || b[0] > n)b = [], c = []; else if (b[0] < m || b[d - 1] > n)e = this.cropData(this.xData, this.yData, m, n), b = e.xData, c = e.yData, e = e.start, f = !0, k = b.length;
        ...
        generatePoints: function () {
            var a = this.options.data,
                b = this.data, c, d = this.processedXData, e = this.processedYData, f = this.pointClass, g = d.length, h = this.cropStart || 0, i, j = this.hasGroupedData, k, l = [], n;
            ...
            if (b && (g !== (c = b.length) || j))for (n = 0; n < c; n++)if (n === h && !j && (n += g), b[n])b[n].destroyElements(), b[n].plotX = r;
            this.data = b;
            this.points = l
        },
        ...
        animate: function (a) {
            ...
            if (d && !fa(d))d = W[this.type].animation;
        ...
        drawPoints: function () {
            var a, b = this.points, c = this.chart, d, e, f, g, h, i, j, k, l = this.options.marker, n = this.pointAttr[""], m, o, s, z = this.markerGroup, t = p(l.enabled, !this.requireSorting || this.activePointCount < 0.5 * this.xAxis.len / l.radius);
            if (l.enabled !== !1 || this._hasPointMarkers)for (f =
                                                                   b.length; f--;)if (g = b[f], d = ea(g.plotX), e = g.plotY, k = g.graphic, m = g.marker || {}, o = !!g.marker, a = t && m.enabled === r || m.enabled, s = c.isInsidePlot(w(d), e, c.inverted), a && e !== r && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""] || n, h = a.r, i = p(m.symbol, this.symbol), j = i.indexOf("url") === 0, k)k[s ? "show" : "hide"](!0).animate(q({
                x: d - h,
                y: e - h
        ...
        getAttribs: function () {
            ...
            var n = b.negativeColor, m = c.lineColor, p = c.fillColor;
            i = b.turboThreshold;
            var r;
            ...
            if (!i || g < i || k)for (; g--;) {
                ...
                if (i.options)for (r in l)t(c[l[r]]) && (k = !0);
                if (k) {
                    c = c || {};
                    k = [];
                    d = c.states || {};
        ...
        drawGraph: function () {
            var a = this, b = this.options, c = [["graph", b.lineColor || this.color]], d = b.lineWidth, e = b.dashStyle, f = b.linecap !==
                "square", g = this.getGraphPath(), h = b.negativeColor;
            h && c.push(["graphNeg", h]);
            o(c, function (c, h) {
                var k = c[0], l = a[k];
                if (l)Va(l), l.animate({d: g}); else if (d && g.length)l = {
                    stroke: c[1],
                    "stroke-width": d,
                    fill: S,
                    zIndex: 1
        ...
        redraw: function () {
            var a = this.chart, b = this.isDirtyData,
                c = this.group, d = this.xAxis, e = this.yAxis;
            c && (a.inverted && c.attr({
                width: a.plotWidth,
                height: a.plotHeight
    ...
    q(pa.prototype, {
        addSeries: function (a, b, c) {
            var d, e = this;
            a && (b = p(b, !0), C(e, "addSeries", {options: a}, function () {
                d = e.initSeries(a);
                e.isDirtyLegend = !0;
                e.linkSeries();
                b && e.redraw(c)
            ...
            new Q(this, v(a, {index: this[e].length, isX: b}));
            f[e] = na(f[e] || {});
            f[e].push(a);
            p(c, !0) && this.redraw(d)
            ...
            if (!d)b.loadingDiv = d = $(Ga, {className: "highcharts-loading"}, q(e.style, {
                zIndex: 10,
                display: S
            ...
            if (!b.loadingShown)D(d, {
                opacity: 0,
                display: ""
            }), eb(d, {opacity: e.style.opacity}, {duration: e.showDuration || 0}), b.loadingShown = !0;
            f()
    ...
    q(T.prototype, {
        addPoint: function (a, b, c, d) {
            ...
            var c = this, d = this.chart, e = this.userOptions, f = this.type, g = u[f].prototype, h = ["group", "markerGroup", "dataLabelsGroup"], i;
            o(h, function (a) {
                h[a] = c[a];
                delete c[a]
            });
            a = v(e, {animation: !1, index: this.index, pointStart: this.xData[0]}, {data: this.options.data},
                a);
            this.remove(!1);
    ...
    q(Q.prototype, {
        update: function (a, b) {
            var c = this.chart, a = c.options[this.coll][this.options.index] = v(this.userOptions, a);
            this.destroy(!0);
            this._addedPlotLB = r;
            this.init(c, q(a, {events: r}));
            c.isDirtyBox = !0;
            p(b, !0) && c.redraw()
        }, remove: function (a) {
    ...
    P = da(T, {
        ...
        getColumnMetrics: function () {
            var a = this, b = a.options,
                c = a.xAxis, d = a.yAxis, e = c.reversed, f, g = {}, h, i = 0;
            ...
            var c = R(U(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len), j = c * b.groupPadding, k = (c - 2 * j) / i, l = b.pointWidth, b = t(l) ? (k - l) / 2 : k * b.pointPadding, l = p(l, k - 2 * b);
        ...
        translate: function () {
            var a = this, b = a.chart, c = a.options, d = a.borderWidth = p(c.borderWidth, a.activePointCount > 0.5 * a.xAxis.len ? 0 : 1), e = a.yAxis, f = a.translatedThreshold = e.getThreshold(c.threshold), g = p(c.minPointLength, 5), h = a.getColumnMetrics(), i = h.width, j = a.barW = s(i, 1 + 2 * d), k = a.pointXOffset = h.offset, l = -(d % 2 ? 0.5 : 0), n = d % 2 ? 0.5 : 1;
            b.renderer.isVML && b.inverted && (n += 1);
            c.pointPadding && (j = Ha(j));
            T.prototype.translate.apply(a);
            o(a.points, function (c) {
                var d =
                    p(c.yBottom, f), h = R(s(-999 - d, c.plotY), e.len + 999 + d), o = c.plotX + k, q = j, r = R(h, d), t;
                t = s(h, d) - r;
                ...
                d && (r -= 1, t += 1);
                c.shapeType = "rect";
                c.shapeArgs = {x: o, y: r, width: q, height: t}
            })
        },
        getSymbol: aa,
        ...
        drawPoints: function () {
            ...
            o(a.points, function (h) {
                ...
                if (i !== r && !isNaN(i) && h.y !== null)f = h.shapeArgs, i = t(a.borderWidth) ? {"stroke-width": a.borderWidth} : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], j ? (Va(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](v(f))) : h.graphic = d[h.shapeType](f).attr(g).attr(i).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius); else if (j)h.graphic = j.destroy()
            })
        },
        animate: function (a) {
            var b = this.yAxis, c = this.options,
                d = this.chart.inverted, e = {};
    ...
    T.prototype.drawDataLabels = function () {
        ...
        a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (j.attr({opacity: +h}), h || N(a, "afterAnimate", function () {
            a.visible && j.show();
            j[b.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
        })), g = d, o(e, function (b) {
            var e, h = b.dataLabel, m, o, s = b.connector, w = !0;
            ...
            if (h && !e)b.dataLabel = h.destroy(); else if (e) {
                ...
                if (h)if (t(i))h.attr({text: i}), w = !1; else {
                    ...
                    h = b.dataLabel = a.chart.renderer[e ? "text" : "label"](i, 0, -999, null, null, null, d.useHTML).attr(h).css(q(d.style, c && {cursor: c})).add(j).shadow(d.shadow)
                }
    ...
    T.prototype.alignDataLabel = function (a, b, c, d, e) {
        ...
        }).attr({align: c.align}) : (b.align(c, null, d), g = b.alignAttr, p(c.overflow,
    ...
    if (u.pie)u.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth, 1), h = d.plotWidth, i = d.plotHeight, j, k, l = p(e.softConnector, !0), n = e.distance, m = a.center, q = m[2] / 2, r = m[1], t = n > 0, u, v, y, B = [[], []], D, C, K, J, A, F = [0, 0, 0, 0], N = function (a, b) {
            return b.y - a.y
        };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                if (L) {
                    ...
                    if (n > 0) {
                        ...
                        for (A = 0; A < L; A++) {
                            ...
                            (c = S, H = Q);
                            if (H < A && I[A] !== null)H = A; else for (v < L - A + H && I[A] !== null && (H = v - L + A); I[H] === null;)H++;
                            P.push({i: H, y: I[H]});
                            I[H] = null
                        }
                        P.sort(N)
                    ...
                    for (A = 0; A < L; A++) {
                        ...
                        u._attr = {visibility: K, align: y[6]};
                        u._pos = {x: D + e.x + ({left: f, right: -f}[y[6]] || 0), y: C + e.y - 10};
                        u.connX = D;
                        u.connY = C;
            ...
            if (Fa(F) === 0 || this.verifyDataLabelOverflow(F))this.placeDataLabels(), t && g && o(this.points, function (b) {
                ...
                if ((u = b.dataLabel) && u._pos)K = u._attr.visibility, D = u.connX, C = u.connY, k = l ? ["M", D + (y[6] === "left" ? 5 : -5), C, "C", D, C, 2 * y[2] - y[4], 2 * y[3] - y[5], y[2], y[3], "L", y[4], y[5]] : ["M", D + (y[6] === "left" ? 5 : -5), C, "L", y[2],
                    y[3], "L", y[4], y[5]], j ? (j.animate({d: k}), j.attr("visibility", K)) : b.connector = j = a.chart.renderer.path(k).attr({
                    "stroke-width": g,
    ...
    q(Za.prototype, {
        defaultColorAxisOptions: {
            ...
            d = v(this.defaultColorAxisOptions, {side: c ? 2 : 1, reversed: !c}, b, {
                isX: c,
                opposite: !c,
                showEmpty: !1,
                title: null,
            ...
            var c = a.padding, d = a.options, e = this.horiz, f = p(d.symbolWidth, e ? 200 : 12), g = p(d.symbolHeight, e ? 12 : 200), h = p(d.labelPadding, e ? 16 : 30), d = p(d.itemDistance, 10);
            this.setLegendColor();
        ...
        }, setState: aa, visible: !0, setVisible: aa, getSeriesExtremes: function () {
            var a;
            ...
            if (b)f = this.toPixels(b.value), f < g ? f = g - 2 : f > g + h && (f = g + h + 2), b.plotX = f, b.plotY = this.len - f, Q.prototype.drawCrosshair.call(this, a, b), b.plotX = d, b.plotY = e, !c && this.cross && this.cross.attr({fill: this.crosshair.color}).add(this.labelGroup)
        },
        getPlotLinePath: function (a, b, c, d, e) {
            ...
            var a = this, b = this.chart, c = this.legendItems, d = b.options.legend, e = d.valueDecimals,
                f = d.valueSuffix || "", g;
            c.length || o(this.dataClasses, function (d, i) {
                var j = !0, k = d.from, l = d.to;
                g = "";
                k === r ? g = "< " : l === r && (g = "> ");
                k !== r && (g += oa(k, e) + f);
                k !== r && l !== r && (g += " - ");
    ...
    var Gb = da(ia, {
        applyOptions: function (a, b) {
            var c = ia.prototype.applyOptions.call(this, a, b), d = this.series, e = d.joinBy;
            ...
            var a =
                this, b = +new Ka, c = Z(a.color), d = Z(a.pointAttr.hover.fill), e = a.series.options.states.normal.animation, f = e && (e.duration || 500), g;
    ...
    u.map = da(u.scatter, v(L, {
        ...
        forceDL: !0,
        getBox: function (a) {
            var b = Number.MAX_VALUE, c = -b, d = b, e = -b, f = b, g = b, h = this.xAxis, i = this.yAxis, j;
            o(a || [], function (a) {
                if (a.path) {
                    if (typeof a.path === "string")a.path = K.splitPath(a.path);
                    var h = a.path || [], i = h.length, m = !1, o = -b, q = b, r = -b, s = b,
                        t = a.properties;
                    if (!a._foundBox) {
        ...
        setData: function (a, b) {
            var c = this.options, d = c.mapData, e = c.joinBy, f = e === null, g = [], h, i, j;
            f && (e = "_i");
            ...
            if (d) {
                ...
                c.allAreas && (a = a || [], e[1] && o(a, function (a) {
                    ...
                    (!e[0] || g.indexOf("|" + b[e[0]] + "|") === -1) && a.push(v(b, {value: null}))
                }))
            }
        ...
        drawPoints: function () {
            var a = this.xAxis, b = this.yAxis, c = this.group, d = this.chart,
                e = d.renderer, f = this.baseTrans;
        ...
        hideOverlappingDataLabels: function () {
            var a = this.points, b = a.length, c, d, e, f;
            o(a, function (a, b) {
                if (b = a.dataLabel)b.oldOpacity = b.opacity, b.newOpacity = 1
            });
            for (c = 0; c < b - 1; ++c) {
                e = a[c].dataLabel;
                for (d = c + 1; d < b; ++d)if (f = a[d].dataLabel, e && f && e.newOpacity !== 0 && f.newOpacity !== 0 && !(f.alignAttr.x > e.alignAttr.x + e.width || f.alignAttr.x + f.width < e.alignAttr.x || f.alignAttr.y > e.alignAttr.y + e.height || f.alignAttr.y + f.height <
                    e.alignAttr.y))(a[c].labelrank < a[d].labelrank ? e : f).newOpacity = 0
            }
            o(a, function (a, b) {
                if (b = a.dataLabel) {
                    if (b.oldOpacity !== b.newOpacity)b[b.isOld ? "animate" : "attr"](q({opacity: b.newOpacity}, b.alignAttr));
                    b.isOld = !0
                }
            })
        },
        ...
        animate: function (a) {
            ...
            if (this.chart.renderer.isSVG)b === !0 && (b = {duration: 1E3}),
                a ? c.attr({
    ...
    q(pa.prototype, {
        renderMapNavigation: function () {
            ...
            if (p(b.enableButtons, b.enabled) && !a.renderer.forExport)for (d in c)if (c.hasOwnProperty(d))f = v(b.buttonOptions,
            ...
            var f = this.xAxis[0], g = f.max - f.min, h = p(b, f.min + g / 2), i = g * a, g = this.yAxis[0], j = g.max - g.min, k = p(c, g.min + j / 2);
            j *= a;
            h = this.fitToBox({
    ...
    W.mapline = v(W.map, {lineWidth: 1, fillColor: "none"});
    u.mapline = da(u.map, {
        type: "mapline",
    ...
    u.mappoint = da(u.scatter, {type: "mappoint", forceDL: !0});
    ...
    u.bubble = da(u.scatter, {
        ...
        applyOpacity: function (a) {
            var b = this.options.marker, c = p(b.fillOpacity, 0.5), a = a || b.fillColor || this.color;
        ...
        getRadii: function (a, b, c, d) {
            var e, f, g, h = this.zData, i = [], j = this.options.sizeBy !==
                "width";
        ...
        translate: function () {
            ...
            2 ? (c.shapeType = "circle", c.shapeArgs = {x: c.plotX, y: c.plotY, r: d}, c.dlBox = {
                x: c.plotX - d,
                y: c.plotY - d,
                width: 2 * d,
                height: 2 * d
    ...
    Q.prototype.beforePadding = function () {
        var a = this, b = this.len, c = this.chart, d =
            0, e = b, f = this.isXAxis, g = f ? "xData" : "yData", h = this.min, i = {}, j = F.min(c.plotWidth, c.plotHeight), k = Number.MAX_VALUE, l = -Number.MAX_VALUE, n = this.max - h, m = b / n, q = [];
        this.tickPositions && (o(this.series, function (b) {
            var d = b.options;
            if (b.bubblePadding && (b.visible || !c.options.chart.ignoreHiddenSeries))if (a.allowZoomOutside = !0, q.push(b), f)o(["minSize", "maxSize"], function (a) {
                var b = d[a], c = /%$/.test(b), b = B(b);
                i[a] = c ? j * b / 100 : b
            }), b.minPxSize = i.minSize, b = b.zData, b.length && (k = p(d.zMin, F.min(k, F.max(Qa(b), d.displayNegative === !1 ? d.zThreshold : -Number.MAX_VALUE))), l = p(d.zMax, F.max(l, Fa(b))))
        }), o(q, function (a) {
            var b = a[g], c = b.length, j;
            f && a.getRadii(k, l, i.minSize, i.maxSize);
            if (n > 0)for (; c--;)typeof b[c] === "number" && (j = a.radii[c], d = Math.min((b[c] - h) * m - j, d), e = Math.max((b[c] - h) * m + j, e))
        }), q.length && n > 0 && p(this.options.min, this.userMin) === r && p(this.options.max, this.userMax) === r && (e -= b, m *= (b + d - e) / b, this.min += d / m, this.max += e / m))
    };
    if (u.bubble)W.mapbubble = v(W.bubble, {animationLimit: 500, tooltip: {pointFormat: "{point.name}: {point.z}"}}),
        u.mapbubble = da(u.bubble, {
            pointClass: da(ia, {applyOptions: Gb.prototype.applyOptions}),
            xyFromShape: !0,
            type: "mapbubble",
            pointArrayMap: ["z"],
        ...
        o(a.features, function (a) {
            ...
            b === "map" || b === "mapbubble" ?
                (i === "Polygon" ? (o(c, f), e.push("Z")) : i === "MultiPolygon" && (o(c, function (a) {
                    o(a, f)
                }), e.push("Z")), e.length && (j = {path: e})) : b === "mapline" ? (i === "LineString" ? f(c) : i === "MultiLineString" && o(c, f), e.length && (j = {path: e})) : b === "mappoint" && i === "Point" && (j = {
                x: c[0],
                y: -c[1]
            });
            j && d.push(q(j, {name: a.name || a.NAME, properties: a}))
        });
    ...
    q(J.lang, {zoomIn: "Zoom in", zoomOut: "Zoom out"});
    J.mapNavigation = {
        buttonOptions: {
            alignTo: "plotBox",
            align: "left",
    ...
    K.Map = function (a, b) {
        ...
        d = a.series;
        a.series = null;
        a = v({chart: {panning: "xy", type: "map"}, xAxis: c, yAxis: v(c, {reversed: !0})}, a, {
            chart: {
                inverted: !1,
                alignTicks: !1,
    ...
    q(Xa.prototype, {
        setItemEvents: function (a, b, c, d, e) {
            ...
            N(a.checkbox, "click", function (b) {
                C(a, "checkboxClick", {checked: b.target.checked},
                    function () {
                        a.select()
                    })
            })
    ...
    q(pa.prototype, {
        showResetZoom: function () {
            var a = this, b = J.lang, c = a.options.chart.resetZoomButton, d = c.theme, e = d.states, f = c.relativeTo === "chart" ? null : "plotBox";
            this.resetZoomButton = a.renderer.button(b.resetZoom, null, null, function () {
                a.zoomOut()
            }, d, e && e.hover).attr({align: c.position.align, title: b.resetZoomTitle}).add().align(c.position, !1, f)
        }, zoomOut: function () {
            var a = this;
            C(a, "selection", {resetSelection: !0}, function () {
                a.zoom()
            })
        }, zoom: function (a) {
            var b,
            ...
            o(b === "xy" ? [1, 0] : [1], function (b) {
                ...
                h.series.length && l > R(k.dataMin, k.min) && i < s(k.dataMax, k.max) && (h.setExtremes(l, i, !1, !1, {trigger: "pan"}), e = !0);
    ...
    q(ia.prototype, {
        select: function (a, b) {
            ...
            var c = this.plotX, d = this.plotY, e = this.series, f = e.options.states, g = W[e.type].marker &&
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                if (this.graphic)g = g && this.graphic.symbolName && o.r, this.graphic.attr(v(o, g ? {
                    ...
                    if (a && i)if (g = i.radius, l = l.symbol || e.symbol,
                ...
                if ((c = f[a] && f[a].halo) && c.size) {
                    ...
                    m.attr(q({fill: Z(this.color || e.color).setOpacity(c.opacity).get()}, c.attributes))[b ? "animate" : "attr"]({d: this.haloPath(c.size)})
                } else m && m.attr({d: []});
                this.state = a
            }
        },
