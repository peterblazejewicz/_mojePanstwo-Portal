...
define("wysihtml5", ["rangy", "rangy-selectionsaverestore"], function (a) {
    var b, d;
    return window.rangy = a, Object.defineProperty && Object.getOwnPropertyDescriptor && Object.getOwnPropertyDescriptor(Element.prototype, "textContent") && !Object.getOwnPropertyDescriptor(Element.prototype, "textContent").get && !function () {
        ...
        return H.fail = i, H.warn = j, {}.hasOwnProperty ? H.util.extend = function (a, b, c) {
            ...
            function g(a, b) {
                ...
                for (c = b; c; c = c.parentNode)if (F(d, c))return c;
                return null
            }
            ...
            function n(a, b, c) {
                ...
                if (g.deleteData(0, b), a.deleteData(b, a.length - b), m(g, a), c)for (d = 0; f = c[d++];)f.node == a && f.offset > b ? (f.node = g, f.offset -= b) : f.node == a.parentNode && f.offset > e(a) && ++f.offset;
                return g
            }
            ...
            var D, E, F, G, H, I = "undefined", J = a.util;
            ...
            function g(a, b, d) {
                ...
                var e = ib(a.startContainer, a.startOffset, b.endContainer, b.endOffset), f = ib(a.endContainer, a.endOffset, b.startContainer, b.startOffset);
            ...
            function i(a, b, c) {
                var d, e, f, g;
                for (c = c || {stop: !1}; f = a.next();)if (a.isPartiallySelectedSubtree()) {
                    if (b(f) === !1)return c.stop = !0, void 0;
                    if (g = a.getSubtreeIterator(), i(g, b, c), g.detach(), c.stop)return
                } else for (d = ab.createIterator(f); e = d.next();)if (b(e) === !1)return c.stop = !0, void 0
            }
            ...
            function E(c, f) {
                ...
                l.prototype = a.rangePrototype, c.prototype = new l, bb.extend(c.prototype, {
                    ...
                    setStartAndEnd: function () {
                        var a = arguments, b = a[0], c = a[1], d = b, e = c;
                        switch (a.length) {
                            case 3:
                                e = a[2];
                                break;
            ...
            var I, J, K, L, M, N, O, P, Q, R, S, T, U, V, W, X, Y, Z, $, _, ab = a.dom, bb = a.util, cb = ab.DomPosition, db = a.DOMException, eb = ab.isCharacterDataNode, fb = ab.getNodeIndex, gb = ab.isOrIsAncestorOf, hb = ab.getDocument, ib = ab.comparePoints, jb = ab.splitDataNode, kb = ab.getClosestAncestorIn, lb = ab.getNodeLength, mb = ab.arrayContains, nb = ab.getRootContainer, ob = a.features.crashyTextNodes;
            n.prototype = {
                _current: null,
                _next: null,
                _first: null,
            ...
            a.features.htmlParsingConforms = R, S = R ? function (a) {
                var b, c = this.startContainer, d = hb(c);
                ...
                compareBoundaryPoints: function (a, b) {
                    ...
                    var d, e, f, g = c(this), h = a.createRange(g);
                    ...
                    var b, c, d, e, f, g, h, i = a.containerNode, j = 0;
                    for (this.setStart(i, 0), this.collapse(!0), b = [i], d = !1, e = !1; !e && (c = b.pop());)if (3 == c.nodeType)f = j + c.length, !d && a.start >= j && a.start <= f && (this.setStart(c, a.start - j), d = !0), d && a.end >= j && a.end <= f && (this.setEnd(c, a.end - j), e = !0), j = f; else for (h = c.childNodes, g = h.length; g--;)b.push(h[g])
                }, getName: function () {
                    return "DomRange"
                }, equals: function (a) {
            ...
            var c, d, e, f, g, h, i, j, k = a.dom, l = a.util, m = k.DomPosition, n = a.DomRange, o = k.getBody, p = k.getContentDocument, q = k.isCharacterDataNode;
            a.features.implementsDomRange && !function () {
                ...
                var b, c, d, e = a.parentElement(), f = a.duplicate();
                ...
                if (y.collapse(c), f = y.parentElement(), k.isOrIsAncestorOf(b, f) || (f = b), !f.canHaveHTML)return g = new m(f.parentNode, k.getNodeIndex(f)), {
                    boundaryPosition: g,
                    nodeInfo: {nodeIndex: g.offset, containerElement: g.node}
                };
                ...
                if (p = h.nextSibling, -1 == i && p && q(p)) {
                    if (y.setEndPoint(c ? "EndToStart" : "EndToEnd", a), /[\r\n]/.test(p.data))for (w = y.duplicate(), x = w.text.replace(/\r\n/g, "\r").length, v = w.moveStart("character", x); -1 == (i = w.compareEndPoints("StartToEnd", w));)v++, w.moveStart("character", 1); else v = y.text.length;
                    o = new m(p, v)
                } else l = (d || !c) && h.previousSibling, n = (d || c) && h.nextSibling, o = n && q(n) ? new m(n, 0) : l && q(l) ? new m(l, l.data.length) : new m(f, k.getNodeIndex(h));
                return h.parentNode.removeChild(h), {boundaryPosition: o, nodeInfo: {nodeIndex: u, containerElement: f}}
            }, h = function (a, b) {
                var c, d, e, f, g = a.offset, h = k.getDocument(a.node), i = o(h).createTextRange(), j = q(a.node);
            ...
            function l(a) {
                ...
                for (var b = 1, c = a.length; c > b; ++b)if (!A.isAncestorOf(a[0], a[b]))return !1;
                return !0
            }
            ...
            function q(a, c) {
                var d, e, f = a.docSelection.createRange(), g = m(c), h = L(f.item(0)), i = M(h).createControlRange();
            ...
            function t(a, b) {
                for (var c, d, e = bb.length; e--;)if (c = bb[e], d = c.selection, "deleteAll" == b)s(d); else if (c.win == a)return "delete" == b ? (bb.splice(e, 1), !0) : d;
                return "deleteAll" == b && (bb.length = 0), null
            }

            function u(a, c) {
                var d, e, f, g = L(c[0].startContainer), h = M(g).createControlRange();
            ...
            function x(a) {
                var b, c, d = [], e = new G(a.anchorNode, a.anchorOffset), f = new G(a.focusNode, a.focusOffset), g = "function" == typeof a.getName ? a.getName() : "Selection";
                if (void 0 !== a.rangeCount)for (b = 0, c = a.rangeCount; c > b; ++b)d[b] = D.inspect(a.getRangeAt(b));
            ...
            if (a.config.checkSelectionRanges = !0, y = "boolean", z = "number", A = a.dom, B = a.util, C = B.isHostMethod, D = a.DomRange, E = a.WrappedRange, F = a.DOMException, G = A.DomPosition, J = a.features, K = "Control", L = A.getDocument, M = A.getBody, N = D.rangesEqual, O = C(window, "getSelection"), P = B.isHostObject(document, "selection"), J.implementsWinGetSelection = O, J.implementsDocSelection = P, Q = P && (!O || a.config.preferTextRange), Q ? (H = f, a.isSelectionValid = function (a) {
                    ...
                    var d = D.getRangeDocument(c), e = a.createRange(d);
            ...
            db.refresh = function (a) {
                var b, c = a ? this._ranges.slice(0) : null, d = this.anchorNode, e = this.anchorOffset;
                if (fb(this), a) {
                    if (b = c.length, b != this._ranges.length)return !0;
                    if (this.anchorNode != d || this.anchorOffset != e)return !0;
                    for (; b--;)if (!N(c[b], this._ranges[b]))return !0;
                    return !1
                }
            }, gb = function (a, b) {
        ...
        a.createModule("SaveRestore", ["WrappedRange"], function (a, b) {
            ...
            function g(b, c) {
                var e, f, g = a.DomRange.getRangeDocument(b), h = "" + b;
        ...
        var c, e, f, g = d.prototype.extend;
        return d._prototyping = !0, c = new this, g.call(c, a), c.base = function () {
        }, delete d._prototyping, e = c.constructor, f = c.constructor = function () {
            if (!d._prototyping)if (this._constructing || this.constructor == f)this._constructing = !0, e.apply(this, arguments), delete this._constructing; else if (null != arguments[0])return (arguments[0].extend || g).call(arguments[0], c)
        }, f.ancestor = this, f.extend = this.extend, f.forEach = this.forEach, f.implement = this.implement, f.prototype = c, f.toString = this.toString, f.valueOf = function (a) {
            return "object" == a ? f : e.valueOf()
        }, g.call(f, b), "function" == typeof f.init && f.init(), f
    }, d.prototype = {
        extend: function (a, b) {
            var c, e, f, g, h, i, j;
            if (arguments.length > 1)c = this[a], !c || "function" != typeof b || c.valueOf && c.valueOf() == b.valueOf() || !/\bbase\b/.test(b) || (e = b.valueOf(), b = function () {
                var a, b = this.base || d.prototype.base;
                return this.base = c, a = e.apply(this, arguments), this.base = b, a
            }, b.valueOf = function (a) {
                return "object" == a ? b : e
            }, b.toString = d.toString), this[a] = b; else if (a) {
                for (f = d.prototype.extend, d._prototyping || "function" == typeof this || (f = this.extend || f), g = {toSource: null}, h = ["constructor", "toString", "valueOf"], i = d._prototyping ? 0 : 1; j = h[i++];)a[j] != g[j] && f.call(this, j, a[j]);
                for (j in a)g[j] || f.call(this, j, a[j])
            }
            return this
        }
    }, d = d.extend({
        ...
        var d = navigator.userAgent, e = document.createElement("div"), f = -1 !== d.indexOf("Gecko") && -1 === d.indexOf("KHTML"), g = -1 !== d.indexOf("AppleWebKit/"), h = -1 !== d.indexOf("Chrome/"), i = -1 !== d.indexOf("Opera/");
        return {
            USER_AGENT: d, supported: function () {
                var c = this.USER_AGENT.toLowerCase(), d = "contentEditable"in e, f = document.execCommand && document.queryCommandSupported && document.queryCommandState, g = document.querySelector && document.querySelectorAll, h = this.isIos() && a(c) < 5 || this.isAndroid() && b(c) < 4 || -1 !== c.indexOf("opera mobi") || -1 !== c.indexOf("hpwos/");
                return d && f && g && !h
                ...
                var b = a.createElement("div"), c = "<article>foo</article>";
    ...
    }(), b.lang.array = function (a) {
        return {
            contains: function (c) {
                if (Array.isArray(c)) {
                    for (var d = c.length; d--;)if (-1 !== b.lang.array(a).indexOf(c[d]))return !0;
                    return !1
                }
                return -1 !== b.lang.array(a).indexOf(c)
            }, indexOf: function (b) {
                ...
                c = b.lang.array(c);
                for (var d = [], e = 0, f = a.length; f > e; e++)c.contains(a[e]) || d.push(a[e]);
                return d
            }, get: function () {
                ...
                for (var c = [], d = a.length, e = 0; d > e;)b.lang.array(c).contains(a[e]) || c.push(a[e]), e++;
                return c
            }
        }
    }, b.lang.Dispatcher = d.extend({
        on: function (a, b) {
        ...
        return {
            merge: function (b) {
                ...
                var d, e = {};
                if (null === a || !b.lang.object(a).isPlainObject())return a;
                for (d in a)a.hasOwnProperty(d) && (e[d] = c ? b.lang.object(a[d]).clone(c) : a[d]);
                return e
            }, isArray: function () {
                return "[object Array]" === Object.prototype.toString.call(a)
            }, isFunction: function () {
        ...
        b.lang.string = function (b) {
            return b += "", {
                trim: function () {
                    return b.replace(a, "").replace(c, "")
                }, interpolate: function (a) {
                    for (var c in a)b = this.replace("#{" + c + "}").by(a[c]);
                    return b
                }, replace: function (a) {
                    return {
                        by: function (c) {
                    ...
                    var f = b.replace(d, function (a) {
                        return e[a]
                    });
                    return a && (f = f.replace(/(?:\r\n|\r|\n)/g, "<br />")), c && (f = f.replace(/  /gi, "&nbsp; ")), f
                }
            }
        }
    }(), function (a) {
        ...
        function e(b) {
            var e = b.parentNode, f = a.lang.string(b.data).escapeHTML(), g = d(e.ownerDocument);
        ...
        var h = a.lang.array(["CODE", "PRE", "A", "SCRIPT", "HEAD", "TITLE", "STYLE"]), i = /((https?:\/\/|www\.)[^\s<]{3,})/gi, j = /([^\w\/\-](,?))$/i, k = 100, l = {
            ")": "(",
            "]": "[",
            "}": "{"
        };
    ...
    }(b), b.dom.contains = function () {
        var a = document.documentElement;
        return a.contains ? function (a, c) {
            return c.nodeType !== b.ELEMENT_NODE && (c = c.parentNode), a !== c && a.contains(c)
        } : a.compareDocumentPosition ? function (a, b) {
            return !!(16 & a.compareDocumentPosition(b))
        } : void 0
    }(), b.dom.convertToList = function () {
        function a(a, b) {
        ...
        function d(d, e, f) {
            if ("UL" === d.nodeName || "OL" === d.nodeName || "MENU" === d.nodeName)return d;
            var g, h, i, j, k, l, m, n, o, p = d.ownerDocument, q = c(p, e), r = d.querySelectorAll("br"), s = r.length;
            for (o = 0; s > o; o++)for (j = r[o]; (k = j.parentNode) && k !== d && k.lastChild === j;) {
                if ("block" === b.dom.getStyle("display").from(k)) {
                    k.removeChild(j);
                    break
                }
                b.dom.insert(j).after(j.parentNode)
            }
            for (g = b.lang.array(d.childNodes).get(), h = g.length, o = 0; h > o; o++)n = n || a(p, q), i = g[o], l = "block" === b.dom.getStyle("display").from(i), m = "BR" === i.nodeName, !l || f && b.dom.hasClass(i, f) ? m ? n = n.firstChild ? null : n : n.appendChild(i) : (n = n.firstChild ? a(p, q) : n, n.appendChild(i), n = null);
            return 0 === g.length && a(p, q), d.parentNode.replaceChild(q, d), q
        }

        return d
    }(), b.dom.copyAttributes = function (a) {
        return {
            from: function (b) {
                return {
                    to: function (c) {
        ...
        var c = ["-webkit-box-sizing", "-moz-box-sizing", "-ms-box-sizing", "box-sizing"], d = function (b) {
            return e(b) ? parseInt(a.getStyle("width").from(b), 10) < b.offsetWidth : !1
        }, e = function (b) {
            for (var d = 0, e = c.length; e > d; d++)if ("border-box" === a.getStyle(c[d]).from(b))return c[d]
        };
        a.copyStyles = function (e) {
            return {
                from: function (f) {
                    d(f) && (e = b.lang.array(e).without(c));
                    for (var g, h = "", i = e.length, j = 0; i > j; j++)g = e[j], h += g + ":" + a.getStyle(g).from(f) + ";";
                    return {
                        to: function (b) {
                            return a.setStyles(h).on(b), {andTo: arguments.callee}
                        }
                    }
                }
            }
        ...
        var a = function (a, b) {
            ...
            if (!a._wysihtml5_supportsHTML5Tags) {
                for (var b = 0, c = d.length; c > b; b++)a.createElement(d[b]);
                a._wysihtml5_supportsHTML5Tags = !0
            }
        }, d = ["abbr", "article", "aside", "audio", "bdi", "canvas", "command", "datalist", "details", "figcaption", "figure", "footer", "header", "hgroup", "keygen", "mark", "meter", "nav", "output", "progress", "rp", "rt", "ruby", "svg", "section", "source", "summary", "time", "track", "video", "wbr"];
        return function (d, e) {
            e = e || document;
            var f;
            return "object" == typeof d && d.nodeType ? (f = e.createElement("div"), f.appendChild(d)) : b.browser.supportsHTML5Tags(e) ? (f = e.createElement("div"), f.innerHTML = d) : (c(e), f = a(d, e)), f
        }
    }(), b.dom.getParentElement = function () {
        function a(a, c) {
            return c && c.length ? "string" == typeof c ? a === c : b.lang.array(c).contains(a) : !0
        }

        function c(a) {
            return a.nodeType === b.ELEMENT_NODE
        }
        ...
        return function (b, f, g, h) {
            var i = f.cssStyle || f.styleRegExp, j = f.className || f.classRegExp;
            for (g = g || 50; g-- && b && "BODY" !== b.nodeName && (!h || b !== h);) {
                if (c(b) && a(b.nodeName, f.nodeName) && (!i || e(b, f.cssStyle, f.styleRegExp)) && (!j || d(b, f.className, f.classRegExp)))return b;
                b = b.parentNode
            }
            return null
        }
    }(), b.dom.getStyle = function () {
        function a(a) {
        ...
        var c = {"float": "styleFloat"in document.createElement("div").style ? "styleFloat" : "cssFloat"}, d = /\-[a-z]/g;
        return function (d) {
            return {
                from: function (e) {
                    var f, g, h, i, j, k, l, m, n;
                    if (e.nodeType === b.ELEMENT_NODE) {
                        if (f = e.ownerDocument, g = c[d] || a(d), h = e.style, i = e.currentStyle, j = h[g], j)return j;
                        if (i)try {
                            return i[g]
                        } catch (o) {
                        }
                        return k = f.defaultView || f.parentWindow, l = ("height" === d || "width" === d) && "TEXTAREA" === e.nodeName, k.getComputedStyle ? (l && (m = h.overflow, h.overflow = "hidden"), n = k.getComputedStyle(e, null).getPropertyValue(d), l && (h.overflow = m || ""), n) : void 0
                    }
                }
            }
        }
    }(), b.dom.getTextNodes = function (a, c) {
        var d = [];
        for (a = a.firstChild; a; a = a.nextSibling)3 == a.nodeType ? c && /^\s*$/.test(a.innerText || a.textContent) || d.push(a) : d = d.concat(b.dom.getTextNodes(a, c));
        return d
    }, b.dom.hasElementWithTagName = function () {
        function a(a) {
        ...
        a.dom.lineBreaks = function (b) {
            ...
            return {
                add: function () {
                    var c = b.ownerDocument, e = a.dom.domNode(b).next({ignoreBlankTexts: !0}), f = a.dom.domNode(b).prev({ignoreBlankTexts: !0});
                    e && !d(e) && a.dom.insert(c.createElement("br")).after(b), f && !d(f) && a.dom.insert(c.createElement("br")).before(b)
                }, remove: function () {
                    var d = a.dom.domNode(b).next({ignoreBlankTexts: !0}), e = a.dom.domNode(b).prev({ignoreBlankTexts: !0});
                    d && c(d) && d.parentNode.removeChild(d), e && c(e) && e.parentNode.removeChild(e)
                }
            }
        }
    }(b), b.dom.observe = function (a, b, c) {
    ...
    }, b.dom.parse = function (a, c) {
        function d(a, c) {
            var d, g, h, i, j, k, l, m, n;
            for (b.lang.object(u).merge(t).merge(c.rules).get(), d = c.context || a.ownerDocument || document, g = d.createDocumentFragment(), h = "string" == typeof a, i = !1, c.clearInternals === !0 && (i = !0), j = h ? b.dom.getAsDom(a, d) : a, u.selectors && f(j, u.selectors); j.firstChild;)l = j.firstChild, k = e(l, c.cleanUp, i, c.uneditableClass), k && g.appendChild(k), l !== k && j.removeChild(l);
            if (c.unjoinNbsps)for (m = b.dom.getTextNodes(g), n = m.length; n--;)m[n].nodeValue = m[n].nodeValue.replace(/([\S\u00A0])\u00A0/gi, "$1 ");
            return j.innerHTML = "", j.appendChild(g), h ? b.quirks.getCorrectInnerHTML(j) : j
        }

        function e(a, c, d, f) {
            var g, h, i, j = a.nodeType, k = a.childNodes, l = k.length, m = q[j], n = 0;
            if (f && 1 === j && b.dom.hasClass(a, f))return a;
            if (h = m && m(a, d), !h) {
                if (h === !1) {
                    for (g = a.ownerDocument.createDocumentFragment(), n = l; n--;)k[n] && (i = e(k[n], c, d, f), i && (k[n] === i && n--, g.insertBefore(i, g.firstChild)));
                    return "block" === b.dom.getStyle("display").from(a) && g.appendChild(a.ownerDocument.createElement("br")), b.lang.array(["div", "pre", "p", "table", "td", "th", "ul", "ol", "li", "dd", "dl", "footer", "header", "section", "h1", "h2", "h3", "h4", "h5", "h6"]).contains(a.nodeName.toLowerCase()) && a.parentNode.lastChild !== a && (a.nextSibling && 3 === a.nextSibling.nodeType && /^\s/.test(a.nextSibling.nodeValue) || g.appendChild(a.ownerDocument.createTextNode(" "))), g.normalize && g.normalize(), g
                }
                return null
            }
            for (n = 0; l > n; n++)k[n] && (i = e(k[n], c, d, f), i && (k[n] === i && n--, h.appendChild(i)));
            if (c && h.nodeName.toLowerCase() === r && (!h.childNodes.length || /^\s*$/gi.test(h.innerHTML) && (d || "_wysihtml5-temp-placeholder" !== a.className && "rangySelectionBoundary" !== a.className) || !h.attributes.length)) {
                for (g = h.ownerDocument.createDocumentFragment(); h.firstChild;)g.appendChild(h.firstChild);
        ...
        function f(a, c) {
            var d, e, f, g;
            for (d in c)if (c.hasOwnProperty(d))for (b.lang.object(c[d]).isFunction() ? e = c[d] : "string" == typeof c[d] && A[c[d]] && (e = A[c[d]]), f = a.querySelectorAll(d), g = f.length; g--;)e(f[g])
        }

        function g(a, c) {
            var d, e, f, g = u.tags, i = a.nodeName.toLowerCase(), k = a.scopeName;
            if (a._wysihtml5)return null;
            if (a._wysihtml5 = 1, "wysihtml5-temp" === a.className)return null;
            if (k && "HTML" != k && (i = k + ":" + i), "outerHTML"in a && (b.browser.autoClosesUnclosedTags() || "P" !== a.nodeName || "</p>" === a.outerHTML.slice(-4).toLowerCase() || (i = "div")), i in g) {
                if (d = g[i], !d || d.remove)return null;
            ...
            if (d.one_of_type && !h(a, u, d.one_of_type, c)) {
                if (!d.remove_action)return null;
                if ("unwrap" === d.remove_action)return !1;
                if ("rename" !== d.remove_action)return null;
                f = d.remove_action_rename_to || r
            }
            return e = a.ownerDocument.createElement(f || d.rename_tag || i), n(a, e, d, c), j(a, e, d), a = null, e.normalize && e.normalize(), e
        }

        function h(a, b, c, d) {
            var e, f;
            if ("SPAN" === a.nodeName && !d && ("_wysihtml5-temp-placeholder" === a.className || "rangySelectionBoundary" === a.className))return !0;
            for (f in c)if (c.hasOwnProperty(f) && b.type_definitions && b.type_definitions[f] && (e = b.type_definitions[f], i(a, e)))return !0;
            return !1
        }

        function i(a, c) {
            var d, e, f, g, h, i, j, k, l = a.getAttribute("class"), m = a.getAttribute("style");
            if (c.methods)for (i in c.methods)if (c.methods.hasOwnProperty(i) && z[i] && z[i](a))return !0;
            if (l && c.classes)for (l = l.replace(/^\s+/g, "").replace(/\s+$/g, "").split(s), d = l.length, j = 0; d > j; j++)if (c.classes[l[j]])return !0;
            if (m && c.styles) {
                m = m.split(";");
                for (e in c.styles)if (c.styles.hasOwnProperty(e))for (k = m.length; k--;)if (h = m[k].split(":"), h[0].replace(/\s/g, "").toLowerCase() === e && (c.styles[e] === !0 || 1 === c.styles[e] || b.lang.array(c.styles[e]).contains(h[1].replace(/\s/g, "").toLowerCase())))return !0
            }
            if (c.attrs)for (f in c.attrs)if (c.attrs.hasOwnProperty(f) && (g = b.dom.getAttribute(a, f), "string" == typeof g && g.search(c.attrs[f]) > -1))return !0;
            return !1
        }

        function j(a, b, c) {
            var d, e;
            if (c && c.keep_styles)for (d in c.keep_styles)if (c.keep_styles.hasOwnProperty(d)) {
        ...
        function m(a, c) {
            var d, e, f, g, h, i = b.lang.object(u.attributes || {}).clone(), j = b.lang.object(i).merge(b.lang.object(c || {}).clone()).get(), m = {}, n = b.dom.getAttributes(a);
            for (d in j)if (/\*$/.test(d))for (f = k(d.slice(0, -1), n), g = 0, h = f.length; h > g; g++)e = l(f[g], n[f[g]], j[d], a.nodeName), e !== !1 && (m[f[g]] = e); else e = l(d, n[d], j[d], a.nodeName), e !== !1 && (m[d] = e);
            return m
        }

        function n(a, c, d, e) {
            var f, g, h, i, j, k = {}, l = d.set_class, n = d.add_class, o = d.add_style, p = d.set_attributes, q = u.classes, r = 0, t = [], v = [], w = [], z = [];
            if (p && (k = b.lang.object(p).clone()), k = b.lang.object(k).merge(m(a, d.check_attributes)).get(), l && t.push(l), n)for (i in n)j = y[n[i]], j && (h = j(b.dom.getAttribute(a, i)), "string" == typeof h && t.push(h));
            if (o)for (i in o)j = x[o[i]], j && (newStyle = j(b.dom.getAttribute(a, i)), "string" == typeof newStyle && v.push(newStyle));
            if ("string" == typeof q && "any" === q && a.getAttribute("class"))if (u.classes_blacklist) {
                for (z = a.getAttribute("class"), z && (t = t.concat(z.split(s))), f = t.length; f > r; r++)g = t[r], u.classes_blacklist[g] || w.push(g);
                w.length && (k["class"] = b.lang.array(w).unique().join(" "))
            } else k["class"] = a.getAttribute("class"); else {
                for (e || (q["_wysihtml5-temp-placeholder"] = 1, q._rangySelectionBoundary = 1, q["wysiwyg-tmp-selected-cell"] = 1), z = a.getAttribute("class"), z && (t = t.concat(z.split(s))), f = t.length; f > r; r++)g = t[r], q[g] && w.push(g);
                w.length && (k["class"] = b.lang.array(w).unique().join(" "))
            }
            k["class"] && e && (k["class"] = k["class"].replace("wysiwyg-tmp-selected-cell", ""), /^\s*$/g.test(k["class"]) && delete k["class"]), v.length && (k.style = b.lang.array(v).unique().join(" "));
            for (i in k)try {
                c.setAttribute(i, k[i])
            } catch (A) {
            }
            k.src && (void 0 !== k.width && c.setAttribute("width", k.width), void 0 !== k.height && c.setAttribute("height", k.height))
        }

        function o(a) {
            var c, d = a.nextSibling;
            return d && d.nodeType === b.TEXT_NODE ? (d.data = a.data.replace(v, "") + d.data.replace(v, ""), void 0) : (c = a.data.replace(v, ""), a.ownerDocument.createTextNode(c))
        }

        function p(a) {
            return u.comments ? a.ownerDocument.createComment(a.nodeValue) : void 0
        }

        var q = {1: g, 3: o, 8: p}, r = "span", s = /\s+/, t = {
            tags: {},
            classes: {}
        }, u = {}, v = /\uFEFF/g, w = {
            url: function () {
        ...
        return d(a, c)
    }, b.dom.removeEmptyTextNodes = function (a) {
        for (var c, d = b.lang.array(a.childNodes).get(), e = d.length, f = 0; e > f; f++)c = d[f], c.nodeType === b.TEXT_NODE && "" === c.data && c.parentNode.removeChild(c)
    }, b.dom.renameElement = function (a, c) {
        for (var d, e = a.ownerDocument.createElement(c); d = a.firstChild;)e.appendChild(d);
        return b.dom.copyAttributes(["align", "className"]).from(a).to(e), a.parentNode.replaceChild(e, a), e
    }, b.dom.replaceWithChildNodes = function (a) {
        if (a.parentNode) {
        ...
        function f(a, f) {
            if (a.nodeName.match(/^(MENU|UL|OL)$/)) {
                var g, h, i, j, k, l, m = a.ownerDocument, n = m.createDocumentFragment(), o = b.dom.domNode(a).prev({ignoreBlankTexts: !0});
                if (f)for (!o || c(o) || d(o) || e(n); l = a.firstElementChild || a.firstChild;) {
                    for (h = l.lastChild; g = l.firstChild;)i = g === h, j = i && !c(g) && !d(g), n.appendChild(g), j && e(n);
                    l.parentNode.removeChild(l)
                } else for (; l = a.firstElementChild || a.firstChild;) {
                    if (l.querySelector && l.querySelector("div, p, ul, ol, menu, blockquote, h1, h2, h3, h4, h5, h6"))for (; g = l.firstChild;)n.appendChild(g); else {
                        for (k = m.createElement("p"); g = l.firstChild;)k.appendChild(g);
                        n.appendChild(k)
                    }
                    l.parentNode.removeChild(l)
                }
        ...
        var b = document, c = ["parent", "top", "opener", "frameElement", "frames", "localStorage", "globalStorage", "sessionStorage", "indexedDB"], e = ["open", "close", "openDialog", "showModalDialog", "alert", "confirm", "prompt", "openDatabase", "postMessage", "XMLHttpRequest", "XDomainRequest"], f = ["referrer", "write", "open", "close"];
        a.dom.Sandbox = d.extend({
            constructor: function (b, c) {
            ...
            }, _onLoadIframe: function (d) {
                var g, h, i, j, k, l, m;
                if (a.dom.contains(b.documentElement, d)) {
                    if (g = this, h = d.contentWindow, i = d.contentWindow.document, j = b.characterSet || b.charset || "utf-8", k = this._getHtml({
                            charset: j,
                        ...
                        for (l = 0, m = e.length; m > l; l++)this._unset(h, e[l], a.EMPTY_FUNCTION);
                        for (l = 0, m = f.length; m > l; l++)this._unset(i, f[l]);
                ...
                if (d = "string" == typeof d ? [d] : d, d)for (c = d.length; c > f; f++)e += '<link rel="stylesheet" href="' + d[f] + '">';
        ...
        var b = document;
        a.dom.ContentEditableArea = d.extend({
        ...
        b.dom.setAttributes = function (b) {
            return {
                on: function (c) {
    ...
    }(b.dom), b.dom.getAttribute = function (a, c) {
        var d, e, f, g = !b.browser.supportsGetAttributeCorrectly();
        return c = c.toLowerCase(), d = a.nodeName, "IMG" == d && "src" == c && b.dom.isLoadedImage(a) === !0 ? a.src : g && "outerHTML"in a ? (e = a.outerHTML.toLowerCase(), f = -1 != e.indexOf(" " + c + "="), f ? a.getAttribute(c) : null) : a.getAttribute(c)
    }, b.dom.getAttributes = function (a) {
        var c, d = !b.browser.supportsGetAttributeCorrectly(), e = a.nodeName, f = [];
        for (c in a.attributes)(a.attributes.hasOwnProperty && a.attributes.hasOwnProperty(c) || !a.attributes.hasOwnProperty && Object.prototype.hasOwnProperty.call(a.attributes, c)) && a.attributes[c].specified && ("IMG" == e && "src" == a.attributes[c].name.toLowerCase() && b.dom.isLoadedImage(a) === !0 ? f.src = a.src : b.lang.array(["rowspan", "colspan"]).contains(a.attributes[c].name.toLowerCase()) && d ? 1 !== a.attributes[c].value && (f[a.attributes[c].name] = a.attributes[c].value) : f[a.attributes[c].name] = a.attributes[c].value);
        return f
    }, b.dom.isLoadedImage = function (a) {
        try {
        ...
        function b(a, b) {
            var c, d, e, f, g = [];
            for (d = 0, e = a.length; e > d; d++)if (c = a[d].querySelectorAll(b), c)for (f = c.length; f--; g.unshift(c[f]));
            return g
        }
        ...
        function f(a, b) {
            for (var c = a.nextSibling; 1 != c.nodeType;)if (c = c.nextSibling, !b || b == c.tagName.toLowerCase())return c;
            return null
        }

        var g = a.dom, h = function (a) {
        ...
        i.prototype = {
            addSpannedCellToMap: function (a, b, c, d, e, f) {
                var g, i, j = [], k = c + (f ? parseInt(f, 10) - 1 : 0), l = d + (e ? parseInt(e, 10) - 1 : 0);
                for (g = c; k >= g; g++)for (void 0 === b[g] && (b[g] = []), i = d; l >= i; i++)b[g][i] = new h(a), b[g][i].isColspan = e && parseInt(e, 10) > 1, b[g][i].isRowspan = f && parseInt(f, 10) > 1, b[g][i].firstCol = i == d, b[g][i].lastCol = i == l, b[g][i].firstRow = g == c, b[g][i].lastRow = g == k, b[g][i].isReal = i == d && g == c, b[g][i].spanCollection = j, j.push(b[g][i])
            }, setCellAsModified: function (a) {
                if (a.modified = !0, a.spanCollection.length > 0)for (var b = 0, c = a.spanCollection.length; c > b; b++)a.spanCollection[b].modified = !0
            }, setTableMap: function () {
                var a, b, c, d, e, f, i, j, k = [], l = this.getTableRows();
                for (a = 0; a < l.length; a++)for (b = l[a], c = this.getRowCells(b), f = 0, void 0 === k[a] && (k[a] = []), d = 0; d < c.length; d++) {
                ...
                var d = this.table.querySelectorAll("table"), e = d ? b(d, "th, td") : [], f = c.querySelectorAll("th, td"), g = e.length > 0 ? a.lang.array(f).without(e) : f;
                return g
            }, getTableRows: function () {
                var c = this.table.querySelectorAll("table"), d = c ? b(c, "tr") : [], e = this.table.querySelectorAll("tr"), f = d.length > 0 ? a.lang.array(e).without(d) : e;
                return f
            }, getMapIndex: function (a) {
                var b, c, d = this.map.length, e = this.map && this.map[0] ? this.map[0].length : 0;
                for (b = 0; d > b; b++)for (c = 0; e > c; c++)if (this.map[b][c].el === a)return {row: b, col: c};
                return !1
                ...
                var d, e, f, g = this.table.ownerDocument, h = g.createDocumentFragment();
                for (e = 0; b > e; e++) {
                    if (d = g.createElement(a), c)for (f in c)c.hasOwnProperty(f) && d.setAttribute(f, c[f]);
                    d.appendChild(document.createTextNode(" ")), h.appendChild(d)
                }
                return h
            }, correctColIndexForUnreals: function (a, b) {
                var c, d, e = this.map[b], f = -1;
                for (c = 0, d = a; a > c; c++)e[c].isReal && f++;
                return f
            }, getLastNewCellOnRow: function (a, b) {
                var c, d, e, f, g = this.getRowCells(a);
                for (e = 0, f = g.length; f > e; e++)if (c = g[e], d = this.getMapIndex(c), d === !1 || void 0 !== b && d.row != b)return c;
                return null
                ...
                if (this.setTableMap(), this.map) {
                    for (c = 0, e = this.map.length; e > c; c++) {
                        for (a = this.map[c], i = !0, f = 0, h = a.length; h > f; f++)if (b = a[f], !(g.getAttribute(b.el, "rowspan") && parseInt(g.getAttribute(b.el, "rowspan"), 10) > 1 && b.firstRow !== !0)) {
                            i = !1;
                            break
                        }
                        if (i)for (f = 0; h > f; f++)this.decreaseCellSpan(a[f], "rowspan")
                    }
                    for (j = this.getTableRows(), c = 0, e = j.length; e > c; c++)a = j[c], 0 == a.childNodes.length && /^\s*$/.test(a.textContent || a.innerText) && d(a)
                }
            }, fillMissingCells: function () {
                var a, b, c, d = 0, f = 0, g = null;
                if (this.setTableMap(), this.map) {
                    for (d = this.map.length, a = 0; d > a; a++)this.map[a].length > f && (f = this.map[a].length);
                    for (b = 0; d > b; b++)for (c = 0; f > c; c++)this.map[b] && !this.map[b][c] && c > 0 && (this.map[b][c] = new h(this.createCells("td", 1)), g = this.map[b][c - 1], g && g.el && g.el.parent && e(this.map[b][c - 1].el, this.map[b][c].el))
                }
            }, rectify: function () {
                ...
                if (this.rectify() && (this.setTableMap(), this.idx = this.getMapIndex(this.cell), this.idx)) {
                    if (a = this.map[this.idx.row][this.idx.col], b = g.getAttribute(a.el, "colspan") ? parseInt(g.getAttribute(a.el, "colspan"), 10) : 1, c = a.el.tagName.toLowerCase(), a.isRowspan) {
                        if (d = parseInt(g.getAttribute(a.el, "rowspan"), 10), d > 1)for (e = 1, f = d - 1; f >= e; e++)this.injectRowAt(this.idx.row + e, this.idx.col, b, c, a);
                ...
                var b, c, d, f = this.getMapIndex(a.el), h = f.row + 1, i = {row: h, col: f.col};
                ...
                var a, b, c, d = [];
                if (this.setTableMap(), this.idx = this.getMapIndex(this.cell), this.idx !== !1)for (a = this.map[this.idx.row], b = 0, c = a.length; c > b; b++)a[b].isReal && d.push(a[b].el);
                return d
            }, getColumnElementsByCell: function () {
                var a, b, c = [];
                if (this.setTableMap(), this.idx = this.getMapIndex(this.cell), this.idx !== !1)for (a = 0, b = this.map.length; b > a; a++)this.map[a][this.idx.col] && this.map[a][this.idx.col].isReal && c.push(this.map[a][this.idx.col].el);
                return c
            }, removeRow: function () {
                var a, b, c, e = g.getParentElement(this.cell, {nodeName: ["TR"]});
                if (e) {
                    if (this.setTableMap(), this.idx = this.getMapIndex(this.cell), this.idx !== !1)for (a = this.map[this.idx.row], b = 0, c = a.length; c > b; b++)a[b].modified || (this.setCellAsModified(a[b]), this.removeRowCell(a[b]));
                    d(e)
                }
                ...
                if (this.setTableMap(), this.idx = this.getMapIndex(this.cell), this.idx !== !1)for (var a = 0, b = this.map.length; b > a; a++)this.map[a][this.idx.col].modified || (this.setCellAsModified(this.map[a][this.idx.col]), this.removeColCell(this.map[a][this.idx.col]))
            }, remove: function (a) {
                if (this.rectify()) {
                    switch (a) {
                        case"row":
                ...
                var e = a.isColspan ? {colspan: g.getAttribute(a.el, "colspan")} : null;
                ...
                var b, c, d, e;
                if (this.setTableMap(), this.idx = this.getMapIndex(this.cell), "after" == a && g.getAttribute(this.cell, "colspan") && (this.idx.col = this.idx.col + parseInt(g.getAttribute(this.cell, "colspan"), 10) - 1), this.idx !== !1)for (d = 0, e = this.map.length; e > d; d++)b = this.map[d], b[this.idx.col] && (c = b[this.idx.col], c.modified || (this.setCellAsModified(c), this.addColCell(c, d, a)))
            }, handleCellAddWithRowspan: function (a, b, c) {
                var d, h, i, j, k = parseInt(g.getAttribute(this.cell, "rowspan"), 10) - 1, l = g.getParentElement(a.el, {nodeName: ["TR"]}), m = a.el.tagName.toLowerCase(), n = this.table.ownerDocument;
                for (j = 0; k > j; j++)if (d = this.correctColIndexForUnreals(this.idx.col, b + j), l = f(l, "tr"), l)if (d > 0)switch (c) {
                    case"before":
                ...
                } else l.insertBefore(this.createCells(m, 1), l.firstChild); else i = n.createElement("tr"), i.appendChild(this.createCells(m, 1)), this.table.appendChild(i)
            }
        }, g.table = {
    ...
    }(b), b.dom.query = function (a, b) {
        var c, d, e, f, g = [];
        for (a.nodeType && (a = [a]), d = 0, e = a.length; e > d; d++)if (c = a[d].querySelectorAll(b), c)for (f = c.length; f--; g.unshift(c[f]));
        return g
        ...
        return a.compareDocumentPosition ? function (a, b) {
            ...
            if (d = 9 === a.nodeType ? a : a.ownerDocument, e = 9 === c.nodeType ? c : c.ownerDocument, a === c)return 0;
            if (a === c.ownerDocument)return 20;
            if (a.ownerDocument === c)return 10;
            if (d !== e)return 1;
            if (2 === a.nodeType && a.childNodes && -1 !== b.lang.array(a.childNodes).indexOf(c))return 20;
            if (2 === c.nodeType && c.childNodes && -1 !== b.lang.array(c.childNodes).indexOf(a))return 10;
            for (f = a, g = [], h = null; f;) {
                if (f == c)return 10;
            ...
            for (f = c, h = null; f;) {
                if (f == a)return 20;
                if (i = b.lang.array(g).indexOf(f), -1 !== i)return j = g[i], k = b.lang.array(j.childNodes).indexOf(g[i - 1]), l = b.lang.array(j.childNodes).indexOf(h), k > l ? 2 : 4;
                h = f, f = f.parentNode
            }
            return 1
        }
    }(), b.dom.unwrap = function (a) {
        if (a.parentNode) {
            for (; a.lastChild;)b.dom.insert(a.lastChild).after(a);
            a.parentNode.removeChild(a)
        }
    }, b.dom.getPastedHtml = function (a) {
        var c;
        return a.clipboardData && (b.lang.array(a.clipboardData.types).contains("text/html") ? c = a.clipboardData.getData("text/html") : b.lang.array(a.clipboardData.types).contains("text/plain") && (c = b.lang.string(a.clipboardData.getData("text/plain")).escapeHTML(!0, !0))), c
    }, b.dom.getPastedHtmlWithDiv = function (a, b) {
        var c = a.selection.getBookmark(), d = a.element.ownerDocument, e = d.createElement("DIV");
    ...
    }, b.quirks.cleanPastedHTML = function () {
        var a = function (a) {
            var c = b.lang.string(a).trim(), d = c.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
            return RegExp("^((?!^" + d + "$).)*$", "i")
        }, c = function (c, d) {
            var e, f, g = b.lang.object(c).clone(!0);
            for (e in g.tags)if (g.tags.hasOwnProperty(e) && g.tags[e].keep_styles)for (f in g.tags[e].keep_styles)g.tags[e].keep_styles.hasOwnProperty(f) && d[f] && (g.tags[e].keep_styles[f] = a(d[f]));
            return g
        }, d = function (a, b) {
            var c, d, e;
            if (!a)return null;
            for (d = 0, e = a.length; e > d; d++)if (a[d].condition || (c = a[d].set), a[d].condition && a[d].condition.test(b))return a[d].set;
            return c
        };
        return function (a, e) {
            var f, g = {
                color: b.dom.getStyle("color").from(e.referenceNode),
                fontSize: b.dom.getStyle("font-size").from(e.referenceNode)
            }, h = c(d(e.rules, a) || {}, g);
            return f = b.dom.parse(a, {
                rules: h,
                cleanUp: !0,
                context: e.referenceNode.ownerDocument,
                uneditableClass: e.uneditableClass,
                clearInternals: !0,
                unjoinNbsps: !0
            }), f
        }
        ...
        return function (c) {
            b.dom.observe(c.element, ["cut", "keydown"], a)
        }
    }(), function (a) {
        var b = "%7E";
    ...
    }(b), b.quirks.tableCellsSelection = function (a, c) {
        function d() {
            return l.observe(a, "mousedown", function (a) {
                var c = b.dom.getParentElement(a.target, {nodeName: ["TD", "TH"]});
                c && e(c)
            }), m
        }

        function e(b) {
            m.start = b, m.end = b, m.cells = [b], m.table = l.getParentElement(m.start, {nodeName: ["TABLE"]}), m.table && (f(), l.addClass(b, n), o = l.observe(a, "mousemove", h), p = l.observe(a, "mouseup", i), c.fire("tableselectstart").fire("tableselectstart:composer"))
        }

        function f() {
            var b, c;
            if (a && (b = a.querySelectorAll("." + n), b.length > 0))for (c = 0; c < b.length; c++)l.removeClass(b[c], n)
        }

        function g(a) {
            for (var b = 0; b < a.length; b++)l.addClass(a[b], n)
        }

        function h(a) {
            var b, d = null, e = l.getParentElement(a.target, {nodeName: ["TD", "TH"]});
            e && m.table && m.start && (d = l.getParentElement(e, {nodeName: ["TABLE"]}), d && d === m.table && (f(), b = m.end, m.end = e, m.cells = l.table.getCellsBetween(m.start, e), m.cells.length > 1 && c.composer.selection.deselect(), g(m.cells), m.end !== b && c.fire("tableselectchange").fire("tableselectchange:composer")))
        }

        function i() {
            o.stop(), p.stop(), c.fire("tableselect").fire("tableselect:composer"), setTimeout(function () {
                j()
            }, 0)
        }

        function j() {
            var b = l.observe(a.ownerDocument, "click", function (a) {
                b.stop(), l.getParentElement(a.target, {nodeName: ["TABLE"]}) != m.table && (f(), m.table = null, m.start = null, m.end = null, c.fire("tableunselect").fire("tableunselect:composer"))
            })
        }

        function k(a, b) {
            m.start = a, m.end = b, m.table = l.getParentElement(m.start, {nodeName: ["TABLE"]}), selectedCells = l.table.getCellsBetween(m.start, m.end), g(selectedCells), j(), c.fire("tableselect").fire("tableselect:composer")
        }
        ...
        var l = b.dom, m = {
            ...
            cells: null,
            select: k
        }, n = "wysiwyg-tmp-selected-cell", o = null, p = null;
        return d()
    }, function (a) {
        var b = /^rgba\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*([\d\.]+)\s*\)/i, c = /^rgb\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*\)/i, d = /^#([0-9a-f][0-9a-f])([0-9a-f][0-9a-f])([0-9a-f][0-9a-f])/i, e = /^#([0-9a-f])([0-9a-f])([0-9a-f])/i, f = function (a) {
            return RegExp("(^|\\s|;)" + a + "\\s*:\\s*[^;$]+", "gi")
        };
        a.quirks.styleParser = {
            parseColor: function (g, h) {
                var i, j, k, l = f(h), m = g.match(l), n = 10;
                if (m) {
        ...
        function c(a) {
            var b = 0;
            if (a.parentNode)do b += a.offsetTop || 0, a = a.offsetParent; while (a);
            return b
        }

        function e(a, b) {
            for (var c = 0; b !== a;)if (c++, b = b.parentNode, !b)throw Error("not a descendant of ancestor!");
            return c
        }

        function f(a) {
            if (!a.canSurroundContents())for (var b = a.commonAncestorContainer, c = e(b, a.startContainer), d = e(b, a.endContainer); !a.canSurroundContents();)c > d ? (a.setStartBefore(a.startContainer), c = e(b, a.startContainer)) : (a.setEndAfter(a.endContainer), d = e(b, a.endContainer))
        }

        var g = b.dom;
        b.Selection = d.extend({
            constructor: function (a, b, c) {
                ...
                var a = this.getRange();
                return a && f(a), a && a.cloneRange()
            }, setBookmark: function (a) {
                a && this.setSelection(a)
            }, setBefore: function (b) {
                var c = a.createRange(this.doc);
                return c.setStartBefore(b), c.setEndBefore(b), this.setSelection(c)
            }, setAfter: function (b) {
                var c = a.createRange(this.doc);
                return c.setStartAfter(b), c.setEndAfter(b), this.setSelection(c)
            }, selectNode: function (c, d) {
                var e = a.createRange(this.doc), f = c.nodeType === b.ELEMENT_NODE, h = "canHaveHTML"in c ? c.canHaveHTML : "IMG" !== c.nodeName, i = f ? c.innerHTML : c.data, j = "" === i || i === b.INVISIBLE_SPACE, k = g.getStyle("display").from(c), l = "block" === k || "list-item" === k;
                if (j && f && h && !d)try {
                    c.innerHTML = b.INVISIBLE_SPACE
                } catch (m) {
                }
                h ? e.selectNodeContents(c) : e.selectNode(c), h && j && f ? e.collapse(l) : h && j && (e.setStartAfter(c), e.setEndAfter(c)), this.setSelection(e)
                ...
                var a, b, c = this.getOwnRanges(), d = [];
                for (a = 0, b = c.length; b > a; a++)d.push(c[a].commonAncestorContainer || this.doc.body);
                return d
            }, findNodesInSelection: function (a) {
                var c, d, e, f = this.getOwnRanges(), g = [];
                for (d = 0, e = f.length; e > d; d++)c = f[d].getNodes([1], function (c) {
                    return b.lang.array(a).contains(c.nodeName)
                }), g = g.concat(c);
                return g
            }, containsUneditable: function () {
                var a, b, c = this.getOwnUneditables(), d = this.getSelection();
                for (a = 0, b = c.length; b > a; a++)if (d.containsNode(c[a]))return !0;
                return !1
            }, deleteContents: function () {
                var a, b = this.getOwnRanges();
                for (a = b.length; a--;)b[a].deleteContents();
                this.setSelection(b[0])
            }, getPreviousNode: function (a, c) {
                var d, e, f;
                return a || (d = this.getSelection(), a = d.anchorNode), a === this.contain ? !1 : (e = a.previousSibling, e === this.contain ? !1 : (e && 3 !== e.nodeType && 1 !== e.nodeType ? e = this.getPreviousNode(e, c) : e && 3 === e.nodeType && /^\s*$/.test(e.textContent) ? e = this.getPreviousNode(e, c) : c && e && 1 === e.nodeType && !b.lang.array(["BR", "HR", "IMG"]).contains(e.nodeName) && /^[\s]*$/.test(e.innerHTML) ? e = this.getPreviousNode(e, c) : e || a === this.contain || (f = a.parentNode, f !== this.contain && (e = this.getPreviousNode(f, c))), e !== this.contain ? e : !1))
            }, getSelectionParentsByTag: function () {
                var a, c, d, e = this.getSelectedOwnNodes(), f = [];
                for (c = 0, d = e.length; d > c; c++)a = e[c].nodeName && "LI" === e[c].nodeName ? e[c] : b.dom.getParentElement(e[c], {nodeName: ["LI"]}, !1, this.contain), a && f.push(a);
                return f.length ? f : null
            }, getRangeToNodeEnd: function () {
                if (this.isCollapsed()) {
                    var b = this.getRange(), c = b.startContainer, d = b.startOffset, e = a.createRange(this.doc);
                    return e.selectNodeContents(c), e.setStart(c, d), e
                }
            }, caretIsLastInSelection: function () {
                var b = (a.createRange(this.doc), this.getSelection(), this.getRangeToNodeEnd().cloneContents()), c = b.textContent;
                return /^\s*$/.test(c)
            }, caretIsFirstInSelection: function () {
                var c = a.createRange(this.doc), d = this.getSelection(), e = this.getRange(), f = e.startContainer;
                return f.nodeType === b.TEXT_NODE ? this.isCollapsed() && f.nodeType === b.TEXT_NODE && /^\s*$/.test(f.data.substr(0, e.startOffset)) : (c.selectNodeContents(this.getRange().commonAncestorContainer), c.collapse(!0), this.isCollapsed() && (c.startContainer === d.anchorNode || c.endContainer === d.anchorNode) && c.startOffset === d.anchorOffset)
            }, caretIsInTheBeginnig: function (a) {
                var c = this.getSelection(), d = c.anchorNode, e = c.anchorOffset;
                return a ? 0 === e && (d.nodeName && d.nodeName === a.toUpperCase() || b.dom.getParentElement(d.parentNode, {nodeName: a}, 1)) : 0 === e && !this.getPreviousNode(d, !0)
            }, caretIsBeforeUneditable: function () {
                var a, b, c, d, e = this.getSelection(), f = e.anchorNode, g = e.anchorOffset;
                if (0 === g && (a = this.getPreviousNode(f, !0), a))for (b = this.getOwnUneditables(), c = 0, d = b.length; d > c; c++)if (a === b[c])return b[c];
                return !1
            }, executeAndRestoreRangy: function (b) {
                var c = this.doc.defaultView || this.doc.parentWindow, d = a.saveSelection(c);
                if (d)try {
                    b()
                } catch (e) {
                    setTimeout(function () {
                ...
                a.restoreSelection(d)
            }, executeAndRestore: function (c, d) {
                var e, f, h, i, j, k, l, m, n, o = this.doc.body, p = d && o.scrollTop, q = d && o.scrollLeft, r = "_wysihtml5-temp-placeholder", s = '<span class="' + r + '">' + b.INVISIBLE_SPACE + "</span>", t = this.getRange(!0);
                if (!t)return c(o, o), void 0;
                t.collapsed || (l = t.cloneRange(), k = l.createContextualFragment(s), l.collapse(!1), l.insertNode(k), l.detach()), j = t.createContextualFragment(s), t.insertNode(j), k && (e = this.contain.querySelectorAll("." + r), t.setStartBefore(e[0]), t.setEndAfter(e[e.length - 1])), this.setSelection(t);
                try {
                    c(t.startContainer, t.endContainer)
                } catch (u) {
                    setTimeout(function () {
                        throw u
                    }, 0)
                }
                if (e = this.contain.querySelectorAll("." + r), e && e.length)for (m = a.createRange(this.doc), h = e[0].nextSibling, e.length > 1 && (i = e[e.length - 1].previousSibling), i && h ? (m.setStartBefore(h), m.setEndAfter(i)) : (f = this.doc.createTextNode(b.INVISIBLE_SPACE), g.insert(f).after(e[0]), m.setStartBefore(f), m.setEndAfter(f)), this.setSelection(m), n = e.length; n--;)e[n].parentNode.removeChild(e[n]); else this.contain.focus();
                d && (o.scrollTop = p, o.scrollLeft = q);
                try {
                    e.parentNode.removeChild(e)
                } catch (v) {
                }
            }, set: function (b, c) {
                var d = a.createRange(this.doc);
                d.setStart(b, c || 0), this.setSelection(d)
            }, insertHTML: function (b) {
                var c, d = (a.createRange(this.doc), this.doc.createElement("DIV")), e = this.doc.createDocumentFragment();
                for (d.innerHTML = b, c = d.lastChild; d.firstChild;)e.appendChild(d.firstChild);
                this.insertNode(e), c && this.setAfter(c)
            }, insertNode: function (a) {
                var b = this.getRange();
                b && b.insertNode(a)
            }, surround: function (a) {
                var b, c, d = this.getOwnRanges(), e = [];
                ...
                return e
            }, deblockAndSurround: function (c) {
                var d, e, f, g = this.doc.createElement("div"), h = a.createRange(this.doc);
                if (g.className = c.className, this.composer.commands.exec("formatBlock", c.nodeName, c.className), d = this.contain.querySelectorAll("." + c.className), d[0])for (d[0].parentNode.insertBefore(g, d[0]), h.setStartBefore(d[0]), h.setEndAfter(d[d.length - 1]), e = h.extractContents(); e.firstChild;)if (f = e.firstChild, 1 == f.nodeType && b.dom.hasClass(f, c.className)) {
                    for (; f.firstChild;)g.appendChild(f.firstChild);
                    "BR" !== f.nodeName && g.appendChild(this.doc.createElement("br")), e.removeChild(f)
                } else g.appendChild(f); else g = null;
                return g
            }, scrollIntoView: function () {
                var a, d = this.doc, e = 5, f = d.documentElement.scrollHeight > d.documentElement.offsetHeight, g = d._wysihtml5ScrollIntoViewElement = d._wysihtml5ScrollIntoViewElement || function () {
                    var a = d.createElement("span");
                    return a.innerHTML = b.INVISIBLE_SPACE, a
                }();
                f && (this.insertNode(g), a = c(g), g.parentNode.removeChild(g), a >= d.body.scrollTop + d.documentElement.offsetHeight - e && (d.body.scrollTop = a))
            }, selectLine: function () {
                b.browser.supportsSelectionModify() ? this._selectLine_W3C() : this.doc.selection && this._selectLine_MSIE()
            }, _selectLine_W3C: function () {
                var a = this.doc.defaultView, b = a.getSelection();
                b.modify("move", "left", "lineboundary"), b.modify("extend", "right", "lineboundary")
            }, _selectLine_MSIE: function () {
                var a, b, c, d, e, f = this.doc.selection.createRange(), g = f.boundingTop, h = this.doc.body.scrollWidth;
                if (f.moveToPoint) {
                ...
                var b = this.getSelection(), c = b && b.rangeCount && b.getRangeAt(0);
                return a !== !0 && this.fixRangeOverflow(c), c
            }, getOwnUneditables: function () {
                var a = g.query(this.contain, "." + this.unselectableClass), c = g.query(a, "." + this.unselectableClass);
                return b.lang.array(a).without(c)
            }, getOwnRanges: function () {
                var a, b, c, d, e, f, g, h = [], i = this.getRange();
                if (i && h.push(i), this.unselectableClass && this.contain && i && (b = this.getOwnUneditables(), b.length > 0))for (d = 0, e = b.length; e > d; d++)for (a = [], f = 0, g = h.length; g > f; f++) {
                ...
                return a.getSelection(this.doc.defaultView || this.doc.parentWindow)
            }, setSelection: function (b) {
                var c = this.doc.defaultView || this.doc.parentWindow, d = a.getSelection(c);
                return d.setSingleRange(b)
            }, createRange: function () {
                return a.createRange(this.doc)
            }, isCollapsed: function () {
                return this.getSelection().isCollapsed
            }, getHtml: function () {
                return this.getSelection().toHtml()
            }, isEndToEndInNode: function (a) {
                var c = this.getRange(), d = c.commonAncestorContainer, e = c.startContainer, f = c.endContainer;
                if (d.nodeType === b.TEXT_NODE && (d = d.parentNode), e.nodeType === b.TEXT_NODE && !/^\s*$/.test(e.data.substr(c.startOffset)))return !1;
                if (f.nodeType === b.TEXT_NODE && !/^\s*$/.test(f.data.substr(c.endOffset)))return !1;
                for (; e && e !== d;) {
                    if (e.nodeType !== b.TEXT_NODE && !b.dom.contains(d, e))return !1;
                    if (b.dom.domNode(e).prev({ignoreBlankTexts: !0}))return !1;
                    e = e.parentNode
                }
                for (; f && f !== d;) {
                    if (f.nodeType !== b.TEXT_NODE && !b.dom.contains(d, f))return !1;
                    if (b.dom.domNode(f).next({ignoreBlankTexts: !0}))return !1;
                    f = f.parentNode
                }
                return b.lang.array(a).contains(d.nodeName) ? d : !1
            }, deselect: function () {
                var a = this.getSelection();
                a && a.removeAllRanges()
            }
        ...
        function i(a, b) {
            var c, d, e, f = [], g = b.split(";"), h = a.getAttribute("style");
            if (h) {
                ...
                for (d = 0, e = f.length; e > d; d++)if (h.match(f[d]))return f[d]
            }
            return !1
        }
        ...
        function k(a, b, c, d) {
            for (var e = a.length; e--;)if (!j(a[e], b, c, d))return !1;
            return a.length ? !0 : !1
        }
        ...
        r.prototype = {
            ...
            getAncestorWithClass: function (d) {
                ...
                var b = this.getAncestorWithClass(a), c = !1;
                return b ? this.cssStyle && (c = "class") : (b = this.getAncestorWithStyle(a), b && (c = "style")), {
                    element: b,
                    type: c
                }
            }, postApply: function (a, b) {
                var c, d, e, f, g, h, i = a[0], j = a[a.length - 1], k = [], l = i, m = j, n = 0, o = j.length;
                ...
                var d, e = b.nodeType == a.TEXT_NODE, f = e ? b.parentNode : b, g = c ? "nextSibling" : "previousSibling";
                if (e) {
                ...
                var d = c.nodeType === a.ELEMENT_NODE, e = "canHaveHTML"in c ? c.canHaveHTML : !0, f = d ? c.innerHTML : c.data, g = "" === f || f === a.INVISIBLE_SPACE;
                if (g && d && e)try {
    ...
    }(b, a), b.Commands = d.extend({
        constructor: function (a) {
            this.editor = a, this.composer = a.composer, this.doc = this.composer.doc
        }, support: function (a) {
            return b.browser.supportsCommand(this.doc, a)
        }, exec: function (a, c) {
            var d = b.commands[a], e = b.lang.array(arguments).get(), f = d && d.exec, g = null;
            if (this.editor.fire("beforecommand:composer"), f)e.unshift(this.composer), g = f.apply(d, e); else try {
                g = this.doc.execCommand(a, !1, c)
            } catch (h) {
            }
            return this.editor.fire("aftercommand:composer"), g
        }, state: function (a) {
            var c = b.commands[a], d = b.lang.array(arguments).get(), e = c && c.state;
            ...
            var c = b.commands[a], d = b.lang.array(arguments).get(), e = c && c.stateValue;
            return e ? (d.unshift(this.composer), e.apply(c, d)) : !1
        }
    }), b.commands.bold = {
        exec: function (a, c) {
            b.commands.formatInline.execWithToggle(a, c, "b")
        }, state: function (a, c) {
            return b.commands.formatInline.state(a, c, "b")
        }
    }, function (a) {
        function b(b, c) {
            var g, h, i, j, k, l, m, n, o, p = b.doc, q = "_wysihtml5-temp-" + +new Date, r = /non-matching-class/g, s = 0;
        ...
        a.commands.createLink = {
            exec: function (a, d, e) {
                ...
                f ? a.selection.executeAndRestore(function () {
                    c(a, f, e)
                }) : (e = "object" == typeof e ? e : {href: e}, b(a, e))
            }, state: function (b, c) {
        ...
        function b(a, b) {
            for (var d, e, f, g = b.length, h = 0; g > h; h++)d = b[h], e = c.getParentElement(d, {nodeName: "code"}), f = c.getTextContent(d), f.match(c.autoLink.URL_REG_EXP) && !e ? e = c.renameElement(d, "code") : c.replaceWithChildNodes(d)
        }
        ...
        var k = a.dom, l = ["H1", "H2", "H3", "H4", "H5", "H6", "P", "PRE", "DIV"];
        a.commands.formatBlock = {
            exec: function (f, g, m, n, o, p, q) {
                var r, s, t, u, v, w = (f.doc, this.state(f, g, m, n, o, p, q)), x = f.config.useLineBreaks, y = x ? "DIV" : "P";
                return m = "string" == typeof m ? m.toUpperCase() : m, w.length ? (f.selection.executeAndRestoreRangy(function () {
                    ...
                    for (var a = r.length; a--;)v = k.getParentElement(r[a], {nodeName: l}), v == f.element && (v = null), v && (m && (v = k.renameElement(v, m)), n && b(v, n, o), p && c(v, p, q), t = !0)
                }), !t)) && h(f, {nodeName: m || y, className: n || null, cssStyle: p || null}), void 0)
            }, state: function (b, c, d, e, f, g, h) {
                var i, j, l, m = b.selection.getSelectedOwnNodes(), n = [];
    ...
    }(b), b.commands.formatCode = {
        exec: function (a, c, d) {
            var e, f, g, h = this.state(a);
            h ? a.selection.executeAndRestore(function () {
                e = h.querySelector("code"), b.dom.replaceWithChildNodes(h), e && b.dom.replaceWithChildNodes(e)
            }) : (f = a.selection.getRange(), g = f.extractContents(), h = a.doc.createElement("pre"), e = a.doc.createElement("code"), d && (e.className = d), h.appendChild(e), e.appendChild(g), f.insertNode(h), a.selection.selectNode(h))
        }, state: function (a) {
            var c = a.selection.getSelectedNode();
            return c && c.nodeName && "PRE" == c.nodeName && c.firstChild && c.firstChild.nodeName && "CODE" == c.firstChild.nodeName ? c : b.dom.getParentElement(c, {nodeName: "CODE"}) && b.dom.getParentElement(c, {nodeName: "PRE"})
        }
    }, function (a) {
        function b(a) {
            var b = d[a];
        ...
        var d = {strong: "b", em: "i", b: "strong", i: "em"}, e = {};
        a.commands.formatInline = {
            exec: function (a, b, d, e, f, g, h, i, j) {
                var k = a.selection.createRange(), l = a.selection.getOwnRanges();
        ...
        a.commands.insertBlockQuote = {
            exec: function (b, c) {
                var d = this.state(b, c), e = b.selection.isEndToEndInNode(["H1", "H2", "H3", "H4", "H5", "H6", "P"]);
                ...
                var c = b.selection.getSelectedNode(), d = a.dom.getParentElement(c, {nodeName: "BLOCKQUOTE"}, !1, b.element);
                return d ? d : !1
            }
        }
    }(b), b.commands.insertHTML = {
        exec: function (a, b, c) {
        ...
        a.commands.insertImage = {
            exec: function (c, d, e) {
                var f, g, h, i, j;
                if (e = "object" == typeof e ? e : {src: e}, f = c.doc, g = this.state(c), g)return c.selection.setBefore(g), i = g.parentNode, i.removeChild(g), a.dom.removeEmptyTextNodes(i), "A" !== i.nodeName || i.firstChild || (c.selection.setAfter(i), i.parentNode.removeChild(i)), a.quirks.redraw(c.element), void 0;
                g = f.createElement(b);
    ...
    }(b), b.commands.insertOrderedList = {
        exec: function (a, c) {
            b.commands.insertList.exec(a, c, "OL")
        }, state: function (a, c) {
            return b.commands.insertList.state(a, c, "OL")
        }
    }, b.commands.insertUnorderedList = {
        exec: function (a, c) {
            b.commands.insertList.exec(a, c, "UL")
        }, state: function (a, c) {
            return b.commands.insertList.state(a, c, "UL")
        }
    }, b.commands.insertList = function (a) {
        var b = function (a, b) {
            if (a && a.nodeName) {
                "string" == typeof b && (b = [b]);
                for (var c = b.length; c--;)if (a.nodeName === b[c])return !0
            }
            return !1
        }, c = function (c, d, e) {
            var f, g, h = {el: null, other: !1};
            return c && (f = a.dom.getParentElement(c, {nodeName: "LI"}), g = "UL" === d ? "OL" : "UL", b(c, d) ? h.el = c : b(c, g) ? h = {
                el: c,
                other: !0
            ...
            d.selection.executeAndRestore(function () {
                var h, i, j = f(g, d);
                if (j.length)for (h = j.length; h--;)a.dom.renameElement(j[h], c.toLowerCase()); else {
            ...
            var d, e = c.selection.getOwnRanges(), f = [];
            ...
            c.selection.executeAndRestoreRangy(function () {
                var d, e, f = "_wysihtml5-temp-" + (new Date).getTime(), g = c.selection.deblockAndSurround({
                    nodeName: "div",
                    className: f
                }), h = /\uFEFF/g;
        ...
        return {
            exec: function (a, b, f) {
                var h = a.doc, i = "OL" === f ? "insertOrderedList" : "insertUnorderedList", j = a.selection.getSelectedNode(), k = c(j, f, a);
                k.el ? k.other ? e(k.el, f, a) : d(k.el, f, a) : a.commands.support(i) ? h.execCommand(i, !1, null) : g(f, a)
            }, state: function (a, b, d) {
                var e = a.selection.getSelectedNode(), f = c(e, d, a);
                return f.el && !f.other ? f.el : !1
            }
        }
    }(b), b.commands.italic = {
        exec: function (a, c) {
            b.commands.formatInline.execWithToggle(a, c, "i")
        }, state: function (a, c) {
            return b.commands.formatInline.state(a, c, "i")
        }
    }, function (a) {
        var b = "wysiwyg-text-align-center", c = /wysiwyg-text-align-[0-9a-z]+/g;
        ...
        var b = "wysiwyg-text-align-left", c = /wysiwyg-text-align-[0-9a-z]+/g;
        ...
        var b = "wysiwyg-text-align-right", c = /wysiwyg-text-align-[0-9a-z]+/g;
        ...
        var b = "wysiwyg-text-align-justify", c = /wysiwyg-text-align-[0-9a-z]+/g;
        ...
        var b = "text-align: right;", c = /(\s|^)text-align\s*:\s*[^;\s]+;?/gi;
        ...
        var b = "text-align: left;", c = /(\s|^)text-align\s*:\s*[^;\s]+;?/gi;
        ...
        var b = "text-align: center;", c = /(\s|^)text-align\s*:\s*[^;\s]+;?/gi;
        ...
        exec: function (a, c) {
            b.commands.formatInline.execWithToggle(a, c, "u")
        }, state: function (a, c) {
            return b.commands.formatInline.state(a, c, "u")
        }
    }, b.commands.undo = {
        exec: function (a) {
    ...
    }, b.commands.mergeTableCells = {
        exec: function (a, c) {
            a.tableSelection && a.tableSelection.start && a.tableSelection.end && (this.state(a, c) ? b.dom.table.unmergeCell(a.tableSelection.start) : b.dom.table.mergeCellsBetween(a.tableSelection.start, a.tableSelection.end))
        }, state: function (a) {
            if (a.tableSelection) {
                var c = a.tableSelection.start, d = a.tableSelection.end;
                if (c && d && c == d && (b.dom.getAttribute(c, "colspan") && parseInt(b.dom.getAttribute(c, "colspan"), 10) > 1 || b.dom.getAttribute(c, "rowspan") && parseInt(b.dom.getAttribute(c, "rowspan"), 10) > 1))return [c]
            }
            return !1
        }
    }, b.commands.addTableCells = {
        exec: function (a, c, d) {
            if (a.tableSelection && a.tableSelection.start && a.tableSelection.end) {
                var e = b.dom.table.orderSelectionEnds(a.tableSelection.start, a.tableSelection.end);
                "before" == d || "above" == d ? b.dom.table.addCells(e.start, d) : ("after" == d || "below" == d) && b.dom.table.addCells(e.end, d), setTimeout(function () {
                    a.tableSelection.select(e.start, e.end)
                }, 0)
            }
        }, state: function () {
            return !1
        }
    }, b.commands.deleteTableCells = {
        exec: function (a, c, d) {
            if (a.tableSelection && a.tableSelection.start && a.tableSelection.end) {
                var e, f = b.dom.table.orderSelectionEnds(a.tableSelection.start, a.tableSelection.end), g = b.dom.table.indexOf(f.start), h = a.tableSelection.table;
                b.dom.table.removeCells(f.start, d), setTimeout(function () {
                    e = b.dom.table.findCell(h, g), e || ("row" == d && (e = b.dom.table.findCell(h, {
                        row: g.row - 1,
                        col: g.col
                    })), "column" == d && (e = b.dom.table.findCell(h, {
                        row: g.row,
                        col: g.col - 1
                    }))), e && a.tableSelection.select(e, e)
                }, 0)
            }
        }, state: function () {
            return !1
        }
    }, b.commands.indentList = {
        exec: function (a) {
            var b = a.selection.getSelectionParentsByTag("LI");
            return b ? this.tryToPushLiLevel(b, a.selection) : !1
        }, state: function () {
            return !1
        }, tryToPushLiLevel: function (a, c) {
            var d, e, f, g, h, i = !1;
            return c.executeAndRestoreRangy(function () {
                for (var c = a.length; c--;)g = a[c], d = "OL" === g.parentNode.nodeName ? "OL" : "UL", e = g.ownerDocument.createElement(d), f = b.dom.domNode(g).prev({nodeTypes: [b.ELEMENT_NODE]}), h = f ? f.querySelector("ul, ol") : null, f && (h ? h.appendChild(g) : (e.appendChild(g), f.appendChild(e)), i = !0)
            }), i
        }
    }, b.commands.outdentList = {
        exec: function (a) {
            var b = a.selection.getSelectionParentsByTag("LI");
            return b ? this.tryToPullLiLevel(b, a) : !1
        }, state: function () {
            return !1
        }, tryToPullLiLevel: function (a, c) {
            var d, e, f, g, h, i = !1, j = this;
            return c.selection.executeAndRestoreRangy(function () {
                var k, l;
                for (k = a.length; k--;)if (g = a[k], g.parentNode && (d = g.parentNode, "OL" === d.tagName || "UL" === d.tagName)) {
                    if (i = !0, e = b.dom.getParentElement(d.parentNode, {nodeName: ["OL", "UL"]}, !1, c.element), f = b.dom.getParentElement(d.parentNode, {nodeName: ["LI"]}, !1, c.element), e && f)g.nextSibling && (h = j.getAfterList(d, g), g.appendChild(h)), e.insertBefore(g, f.nextSibling); else {
                        for (g.nextSibling && (h = j.getAfterList(d, g), g.appendChild(h)), l = g.childNodes.length; l--;)d.parentNode.insertBefore(g.childNodes[l], d.nextSibling);
        ...
        var b = 90, c = 89, d = 8, e = 46, f = 25, g = "data-wysihtml5-selection-node", h = "data-wysihtml5-selection-offset", i = ('<span id="_wysihtml5-undo" class="_wysihtml5-temp">' + a.INVISIBLE_SPACE + "</span>", '<span id="_wysihtml5-redo" class="_wysihtml5-temp">' + a.INVISIBLE_SPACE + "</span>", a.dom);
            ...
            constructor: function (a) {
                ...
                i.observe(this.element, "keydown", function (a) {
                    if (!a.altKey && (a.ctrlKey || a.metaKey)) {
                        var d = a.keyCode, e = d === b && !a.shiftKey, g = d === b && a.shiftKey || d === c;
                ...
                var b, c, d, e, i, j, k, l = this.historyStr[this.position - 1], m = this.composer.getValue(!1, !1), n = this.element.offsetWidth > 0 && this.element.offsetHeight > 0;
        ...
        a.views.Composer = a.views.View.extend({
            name: "composer", CARET_HACK: "<br>", constructor: function (a, b, c) {
                ...
                var d, e, f, g = this, h = c.canDisableAutoLinking(), i = c.doesAutoLinkingInContentEditable();
                h && this.commands.exec("autoUrlDetect", !1), this.config.autoLink && ((!i || i && h) && (this.parent.on("newword:composer", function () {
                    b.getTextContent(g.element).match(b.autoLink.URL_REG_EXP) && g.selection.executeAndRestore(function (c, d) {
                        var e, f = g.element.querySelectorAll("." + g.config.uneditableContainerClassname), h = !1;
                    ...
                    if (d.length) {
                        var c, h = g.selection.getSelectedNode(a.target.ownerDocument), i = b.getParentElement(h, {nodeName: "A"}, 4);
                ...
                if (this.commands.exec("enableObjectResizing", !0), c.supportsEvent("resizeend")) {
                    ...
                    b.observe(f, "resizeend", function (b) {
                        var c, g = b.target || b.srcElement, h = g.style, i = 0;
                        if ("IMG" === g.nodeName) {
                ...
                function d(a) {
                    var c = b.getParentElement(a, {nodeName: ["P", "DIV"]}, 2);
                ...
                var e = this, f = ["LI", "P", "H1", "H2", "H3", "H4", "H5", "H6"], g = ["UL", "OL", "MENU"];
                this.config.useLineBreaks || b.observe(this.element, ["focus", "keydown"], function () {
                    ...
                    var h, i = c.keyCode;
                    if (!c.shiftKey && (i === a.ENTER_KEY || i === a.BACKSPACE_KEY))return h = b.getParentElement(e.selection.getSelectedNode(), {nodeName: f}, 4), h ? (setTimeout(function () {
                        var c, f = e.selection.getSelectedNode();
                        if ("LI" === h.nodeName) {
                            if (!f)return;
                            c = b.getParentElement(f, {nodeName: g}, 2), c || d(f)
                        }
        ...
        var b = a.dom, c = document, d = window, e = c.createElement("div"), f = ["background-color", "color", "cursor", "font-family", "font-size", "font-style", "font-variant", "font-weight", "line-height", "letter-spacing", "text-align", "text-decoration", "text-indent", "text-rendering", "word-break", "word-wrap", "word-spacing"], g = ["background-color", "border-collapse", "border-bottom-color", "border-bottom-style", "border-bottom-width", "border-left-color", "border-left-style", "border-left-width", "border-right-color", "border-right-style", "border-right-width", "border-top-color", "border-top-style", "border-top-width", "clear", "display", "float", "margin-bottom", "margin-left", "margin-right", "margin-top", "outline-color", "outline-offset", "outline-width", "outline-style", "padding-left", "padding-right", "padding-top", "padding-bottom", "position", "top", "left", "right", "bottom", "z-index", "vertical-align", "text-align", "-webkit-box-sizing", "-moz-box-sizing", "-ms-box-sizing", "box-sizing", "-webkit-box-shadow", "-moz-box-shadow", "-ms-box-shadow", "box-shadow", "-webkit-border-top-right-radius", "-moz-border-radius-topright", "border-top-right-radius", "-webkit-border-bottom-right-radius", "-moz-border-radius-bottomright", "border-bottom-right-radius", "-webkit-border-bottom-left-radius", "-moz-border-radius-bottomleft", "border-bottom-left-radius", "-webkit-border-top-left-radius", "-moz-border-radius-topleft", "border-top-left-radius", "width", "height"], h = ["html                 { height: 100%; }", "body                 { height: 100%; padding: 1px 0 0 0; margin: -1px 0 0 0; }", "body > p:first-child { margin-top: 0; }", "._wysihtml5-temp     { display: none; }", a.browser.isGecko ? "body.placeholder { color: graytext !important; }" : "body.placeholder { color: #a9a9a9 !important; }", "img:-moz-broken      { -moz-force-broken-image-icon: 1; height: 24px; width: 24px; }"], i = function (a) {
            if (a.setActive)try {
                a.setActive()
            } catch (e) {
            } else {
                var f = a.style, g = c.documentElement.scrollTop || c.body.scrollTop, h = c.documentElement.scrollLeft || c.body.scrollLeft, i = {
                    position: f.position,
                    top: f.top,
                    left: f.left,
        ...
        a.views.Composer.prototype.style = function () {
            var d, j, k = this, l = c.querySelector(":focus"), m = this.textarea.element, n = m.hasAttribute("placeholder"), o = n && m.getAttribute("placeholder"), p = m.style.display, q = m.disabled;
        ...
        var b = a.dom, c = a.browser, d = {66: "bold", 73: "italic", 85: "underline"}, e = function (a, b, c) {
            var d, e = a.getPreviousNode(b, !0), f = a.getSelectedNode();
            if (1 !== f.nodeType && f.parentNode !== c && (f = f.parentNode), e)if (1 == f.nodeType) {
                if (d = f.firstChild, 1 == e.nodeType)for (; f.firstChild;)e.appendChild(f.firstChild); else for (; f.firstChild;)b.parentNode.insertBefore(f.firstChild, b);
        ...
        a.views.Composer.prototype.observe = function () {
            var e, h, i = this, j = this.getValue(!1, !1), k = this.sandbox.getIframe ? this.sandbox.getIframe() : this.sandbox.getContentEditable(), l = this.element, m = c.supportsEventsInIframeCorrectly() || this.sandbox.getContentEditable ? l : this.sandbox.getWindow(), n = ["drop", "paste", "beforepaste"], o = ["drop", "paste", "mouseup", "focus", "keyup"];
            b.observe(k, "DOMNodeRemoved", function () {
                ...
                if (j !== i.getValue(!1, !1)) {
                    var b = a;
                    "function" == typeof Object.create && (b = Object.create(a, {type: {value: "change"}})), i.parent.fire("change", b).fire("change:composer", b)
                }
                ...
                var c = b.target, d = l.querySelectorAll("img"), e = l.querySelectorAll("." + i.config.uneditableContainerClassname + " img"), f = a.lang.array(d).without(e);
                ...
                if (a.metaKey || a.ctrlKey) {
                    var b = a.keyCode, c = l.ownerDocument.defaultView, d = c.getSelection();
                ...
                var c, d = i.selection.getSelectedNode(!0), e = b.keyCode;
        ...
        a.views.Synchronizer = d.extend({
            constructor: function (a, b, c) {
                ...
                var c, d = this, e = this.textarea.element.form, f = function () {
    ...
    }(b),b.views.Textarea = b.views.View.extend({
        name: "textarea", constructor: function (a, b, c) {
            ...
            var a = b.browser.supportsPlaceholderAttributeOn(this.element), c = this.element.getAttribute("placeholder") || null, d = this.element.value, e = !d;
            return a && e || d === c
        }, isEmpty: function () {
            return !b.lang.string(this.element.value).trim() || this.hasPlaceholderSet()
        }, _observe: function () {
            var a = this.element, c = this.parent, d = {
                focusin: "focus",
                focusout: "blur"
            }, e = b.browser.supportsEvent("focusin") ? ["focusin", "focusout", "change"] : ["focus", "blur", "change"];
            c.on("beforeload", function () {
                b.dom.observe(a, e, function (a) {
                    var b = d[a.type] || a.type;
                    c.fire(b).fire(b + ":textarea")
                }), b.dom.observe(a, ["paste", "drop"], function () {
                    setTimeout(function () {
        ...
        a.Editor = a.lang.Dispatcher.extend({
            constructor: function (b, d) {
                ...
                var d = this.config.contentEditableMode ? document : this.composer ? this.composer.sandbox.getDocument() : null, e = this.config.parser(b, {
        ...
        var b = a.dom, c = "wysihtml5-command-dialog-opened", d = "input, select, textarea", e = "[data-wysihtml5-dialog-field]", f = "data-wysihtml5-dialog-field";
        a.toolbar.Dialog = a.lang.Dispatcher.extend({
            constructor: function (a, b) {
                ...
                if (!b.hasClass(this.link, c)) {
                    var e = this, f = this.container.querySelector(d);
        ...
        var b = "wysihtml5-command-disabled", c = "wysihtml5-commands-disabled", e = "wysihtml5-command-active", f = "wysihtml5-action-active", g = a.dom;
        a.toolbar.Toolbar = d.extend({
            constructor: function (d, g, h) {
                this.editor = d, this.container = "string" == typeof g ? document.getElementById(g) : g, this.composer = d.composer, this._getLinks("command"), this._getLinks("action"), this._observe(), h && this.show(), null != d.config.classNameCommandDisabled && (b = d.config.classNameCommandDisabled), null != d.config.classNameCommandsDisabled && (c = d.config.classNameCommandsDisabled), null != d.config.classNameCommandActive && (e = d.config.classNameCommandActive), null != d.config.classNameActionActive && (f = d.config.classNameActionActive);
                ...
                for (var a = this, b = this.editor, d = this.container, e = this.commandLinks.concat(this.actionLinks), f = e.length, h = 0; f > h; h++)"A" === e[h].nodeName ? g.setAttributes({
                    href: "javascript:;",
                    unselectable: "on"
                }).on(e[h]) : g.setAttributes({unselectable: "on"}).on(e[h]);
                g.delegate(d, "[data-wysihtml5-command], [data-wysihtml5-action]", "mousedown", function (a) {
                    a.preventDefault()
                }), g.delegate(d, "[data-wysihtml5-command]", "click", function (b) {
                    var c = this, d = c.getAttribute("data-wysihtml5-command"), e = c.getAttribute("data-wysihtml5-command-value");
                    a.execCommand(d, e), b.preventDefault()
                }), g.delegate(d, "[data-wysihtml5-action]", "click", function (b) {
                    ...
                    b.textarea && setTimeout(function () {
                        a.commandsDisabled = "composer" !== e, a._updateLinkStates(), a.commandsDisabled ? g.addClass(d, c) : g.removeClass(d, c)
                    }, 0)
                })
            }, _updateLinkStates: function () {
                var c, d, h, i, j = this.commandMapping, k = this.actionMapping;
                for (c in j)i = j[c], this.commandsDisabled ? (d = !1, g.removeClass(i.link, e), i.group && g.removeClass(i.group, e), i.dialog && i.dialog.hide()) : (d = this.composer.commands.state(i.name, i.value), g.removeClass(i.link, b), i.group && g.removeClass(i.group, b)), i.state !== d && (i.state = d, d ? (g.addClass(i.link, e), i.group && g.addClass(i.group, e), i.dialog && ("object" == typeof d || a.lang.object(d).isArray() ? (!i.dialog.multiselect && a.lang.object(d).isArray() && (d = 1 === d.length ? d[0] : !0, i.state = d), i.dialog.show(d)) : i.dialog.hide())) : (g.removeClass(i.link, e), i.group && g.removeClass(i.group, e), i.dialog && i.dialog.hide()));
                for (c in k)h = k[c], "change_view" === h.name && (h.state = this.editor.currentView === this.editor.textarea, h.state ? g.addClass(h.link, f) : g.removeClass(h.link, f))
            }, show: function () {
        ...
        var b = (a.dom, "[data-wysihtml5-dialog-field]"), c = "data-wysihtml5-dialog-field";
        a.toolbar.Dialog_foreColorStyle = a.toolbar.Dialog.extend({
            multiselect: !0, _serialize: function () {
        ...
        a.toolbar.Dialog_fontSizeStyle = a.toolbar.Dialog.extend({
            multiselect: !0, _serialize: function () {
                ...
                var b = document.querySelector(":focus"), c = this.container.querySelector("[data-wysihtml5-dialog-field='size']"), d = this.elementToChange ? a.lang.object(this.elementToChange).isArray() ? this.elementToChange[0] : this.elementToChange : null, e = d ? d.getAttribute("style") : null, f = e ? a.quirks.styleParser.parseFontSize(e) : null;
    ...
    function e(a) {
        return a instanceof j ? "" + a : a || 0 === a ? (a = "" + a, m.test(a) ? a.replace(l, c) : a) : ""
    }

    function f(a) {
        return a || 0 === a ? i(a) && 0 === a.length ? !0 : !1 : !0
    }

    var g, h, i, j = a["default"], k = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;",
        '"': "&quot;",
    ...
    b.extend = d, g = Object.prototype.toString, b.toString = g, h = function (a) {
        return "function" == typeof a
    }, h(/x/) && (h = function (a) {
        return "function" == typeof a && "[object Function]" === g.call(a)
    }), b.isFunction = h, i = Array.isArray || function (a) {
        return a && "object" == typeof a ? "[object Array]" === g.call(a) : !1
    }, b.isArray = i, b.escapeExpression = e, b.isEmpty = f
    ...
    function e(a) {
        a.registerHelper("helperMissing", function (a) {
            ...
            return j(b) && (b = b.call(this)), b === !0 ? e(this) : b === !1 || null == b ? d(this) : i(b) ? b.length > 0 ? a.helpers.each(b, c) : d(this) : e(b)
        }), a.registerHelper("each", function (a, b) {
            var c, d, e, f = b.fn, g = b.inverse, h = 0, k = "";
            if (j(a) && (a = a.call(this)), b.data && (c = n(b.data)), a && "object" == typeof a)if (i(a))for (d = a.length; d > h; h++)c && (c.index = h, c.first = 0 === h, c.last = h === a.length - 1), k += f(a[h], {data: c}); else for (e in a)a.hasOwnProperty(e) && (c && (c.key = e, c.index = h, c.first = 0 === h), k += f(a[e], {data: c}), h++);
            return 0 === h && (k = g(this)), k
        }), a.registerHelper("if", function (a, b) {
            return j(a) && (a = a.call(this)), !b.hash.includeZero && !a || o.isEmpty(a) ? b.inverse(this) : b.fn(this)
        }), a.registerHelper("unless", function (b, c) {
            return a.helpers["if"].call(this, b, {fn: c.inverse, inverse: c.fn, hash: c.hash})
        }), a.registerHelper("with", function (a, b) {
            return j(a) && (a = a.call(this)), o.isEmpty(a) ? void 0 : b.fn(a)
    ...
    var g, h, i, j, k, l, m, n, o = a, p = b["default"], q = "1.3.0";
    c.VERSION = q, g = 4, c.COMPILER_REVISION = g, h = {
        1: "<= 1.0.rc.2",
        2: "== 1.0.0-rc.3",
        3: "== 1.0.0-rc.4",
        4: ">= 1.0.0"
    }, c.REVISION_CHANGES = h, i = o.isArray, j = o.isFunction, k = o.toString, l = "[object Object]", c.HandlebarsEnvironment = d, d.prototype = {
        constructor: d,
        logger: m,
        log: f,
        ...
        registerPartial: function (a, b) {
            k.call(a) === l ? o.extend(this.partials, a) : this.partials[a] = b
        }
    }, m = {
    ...
    }, c.logger = m, c.log = f, n = function (a) {
        var b = {};
        return o.extend(b, a), b
    }, c.createFrame = n
}), define("handlebars/runtime", ["./utils", "./exception", "./base", "exports"], function (a, b, c, d) {
    function e(a) {
        var b, c, d = a && a[0] || 1, e = m;
        if (d !== e)throw e > d ? (b = n[e], c = n[d], new l("Template was precompiled with an older version of Handlebars than the current runtime. Please update your precompiler to a newer version (" + b + ") or downgrade your runtime to an older version (" + c + ").")) : new l("Template was precompiled with a newer version of Handlebars than the current runtime. Please update your runtime to a newer version (" + a[1] + ").")
    }

    function f(a, b) {
        var c, d;
        if (!b)throw new l("No environment passed to template");
        return c = function (a, c, d, e, f, g) {
            ...
            if (b.compile)return h = {
                ...
                partials: f,
                data: g
            }, f[c] = b.compile(a, {data: void 0 !== g}, b), f[c](d, h);
            ...
            var f, g, h, i;
            return e = e || {}, f = e.partial ? e : b, e.partial || (g = e.helpers, h = e.partials), i = a.call(d, f, c, g, h, e.data), e.partial || b.VM.checkRevision(d.compilerInfo), i
        }
    }
    ...
    var k = a, l = b["default"], m = c.COMPILER_REVISION, n = c.REVISION_CHANGES;
    d.checkRevision = e, d.template = f, d.programWithDepth = g, d.program = h, d.invokePartial = i, d.noop = j
    ...
    var g = a, h = b["default"], i = c["default"], j = d, k = e, l = function () {
...
}), define("bootstrap.wysihtml5.templates", ["handlebars.runtime", "wysihtml5"], function (a, b) {
    this.wysihtml5 = b;
    var c = a.default;
    this.wysihtml5 = this.wysihtml5 || {}, this.wysihtml5.tpl = this.wysihtml5.tpl || {}, this.wysihtml5.tpl.blockquote = c.template(function (a, b, c, d, e) {
        function f(a) {
            var b, c = "";
    ...
    }), this.wysihtml5.tpl.color = c.template(function (a, b, c, d, e) {
        function f(a) {
            var b, c = "";
    ...
    }), this.wysihtml5.tpl.emphasis = c.template(function (a, b, c, d, e) {
        function f(a) {
            var b, c = "";
    ...
    }), this.wysihtml5.tpl["font-styles"] = c.template(function (a, b, c, d, e) {
        function f(a) {
            var b, c = "";
            return c += "btn-" + l((b = a && a.options, b = null == b || b === !1 ? b : b.toolbar, b = null == b || b === !1 ? b : b.size, typeof b === k ? b.apply(a) : b)), c
        }
    ...
    }), this.wysihtml5.tpl.html = c.template(function (a, b, c, d, e) {
        function f(a) {
            var b, c = "";
            return c += "btn-" + l((b = a && a.options, b = null == b || b === !1 ? b : b.toolbar, b = null == b || b === !1 ? b : b.size, typeof b === k ? b.apply(a) : b)), c
        }
    ...
    }), this.wysihtml5.tpl.image = c.template(function (a, b, c, d, e) {
        function f() {
            return "modal-sm"
        }
    ...
    }), this.wysihtml5.tpl.link = c.template(function (a, b, c, d, e) {
        function f() {
            return "modal-sm"
        }
    ...
    }), this.wysihtml5.tpl.lists = c.template(function (a, b, c, d, e) {
        function f(a) {
            var b, c = "";
...
}), define("bootstrap.wysihtml5.commands", ["wysihtml5"], function (a) {
    !function (a) {
        a.commands.small = {
            exec: function (b, c) {
    ...
    "use strict";
    "function" == typeof define && define.amd ? define("bootstrap.wysihtml5", ["jquery", "wysihtml5", "bootstrap", "bootstrap.wysihtml5.templates", "bootstrap.wysihtml5.commands"], a) : a(jQuery, wysihtml5)
}(function (a, b) {
    "use strict";
    var c = function (a, b) {
        ...
        g.prototype = {
            constructor: g, createEditor: function (b) {
                ...
                if (e.on("beforeload", this.syncBootstrapDialogEvents), e.on("beforeload", this.loadParserRules), e.composer.editableArea.contentDocument ? this.addMoreShortcuts(e, e.composer.editableArea.contentDocument.body || e.composer.editableArea.contentDocument, c.shortcuts) : this.addMoreShortcuts(e, e.composer.editableArea, c.shortcuts), c && c.events)for (d in c.events)c.events.hasOwnProperty(d) && e.on(d, c.events[d]);
                return e
                ...
                return j.find('a[data-wysihtml5-command="formatBlock"]').click(function (b) {
                    var c = b.delegateTarget || b.target || b.srcElement, d = a(c), e = d.data("wysihtml5-display-format-name"), f = d.data("wysihtml5-format-name") || d.html();
            ...
            resetDefaults: function () {
                ...
                var d = a.extend({}, a.fn.wysihtml5.defaultOptions, b || {}, a(this).data()), e = this;
                return c.bypassDefaults.apply(e, [d])
            }, deepExtend: function (b) {
                var d = a.extend(!0, {}, a.fn.wysihtml5.defaultOptions, b || {}), e = this;
                return c.bypassDefaults.apply(e, [d])
            }, init: function (a) {
                var b = this;
            ...
            locale: "en",
            shortcuts: {83: "small", 75: "createLink"}
