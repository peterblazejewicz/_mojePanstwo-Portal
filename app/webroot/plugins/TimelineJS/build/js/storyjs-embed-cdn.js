...
var embed_analytics = "UA-537357-20", load_time_start = (new Date).getTime(), the_load_time = 0, _gaq = _gaq || [];
(function () {
...
var getUrlVars = function () {
    var e = {}, t = [], n;
    t = window.location.href.slice(window.location.href.indexOf("?") + 1);
    t.match("#") && (t = t.split("#")[0]);
    t = t.split("&");
    ...
    return e
}, onHeadline = function (e, t) {
    var n = "/" + t, r = location.href;
    document.title = t;
    the_load_time = Math.floor(((new Date).getTime() - load_time_start) / 100) / 10;
    _gaq.push(["_trackEvent", "Timeline", t, r, the_load_time])
}, url_config = getUrlVars();
LazyLoad = function (e) {
    function u(t, n) {
