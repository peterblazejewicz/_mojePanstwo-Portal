    ...
    "select(body)": {
        ...
        "on a simple page": {
            ...
            "sets properties as a map of functions": function (body) {
                body.data(["cyan"]).property({
                    bgcolor: String, opacity: function (d, i) {
                        return i;
                    }
                });
            ...
            "removes a property as a function": function (body) {
                body.property("bgcolor", "yellow").property("bgcolor", function () {
                    return null
                });
                assert.isFalse("bgcolor" in body.node());
            },
    ...
    "selectAll(div)": {
        ...
        "on a simple page": {
            ...
            "removes a property as a function": function (div) {
                div.property("bgcolor", "yellow").property("bgcolor", function () {
                    return null
                });
                assert.isFalse("bgcolor" in div[0][0]);
                assert.isFalse("bgcolor" in div[0][1]);
