    ...
    "graticule": {
        ...
        "extent": {
            "sets minorExtent and majorExtent": function (graticule) {
                var g = graticule().extent([
                    [-90, -45],
                    [90, 45]
                ]);
                assert.deepEqual(g.minorExtent(), [
                    [-90, -45],
                    [90, 45]
                ]);
                assert.deepEqual(g.majorExtent(), [
                    [-90, -45],
                    [90, 45]
                ]);
            },
            "gets minorExtent": function (graticule) {
                var g = graticule().minorExtent([
                    [-90, -45],
                    [90, 45]
                ]);
                assert.deepEqual(g.extent(), [
                    [-90, -45],
                    [90, 45]
                ]);
            }
        ...
        "lines": {
            "default longitude ranges from 180°W (inclusive) to 180°E (exclusive)": function (graticule) {
                var lines = graticule().lines()
                    .filter(function (line) {
                        return line.coordinates[0][0] === line.coordinates[1][0];
                    })
                    .sort(function (a, b) {
            ...
            "default latitude ranges from 90°S (exclusive) to 90°N (exclusive)": function (graticule) {
                var lines = graticule().lines()
                    .filter(function (line) {
                        return line.coordinates[0][1] === line.coordinates[1][1];
                    })
                    .sort(function (a, b) {
                        return a.coordinates[0][1] - b.coordinates[0][1];
                    });
            ...
            "default minor longitude lines extend from 80°S to 80°N": function (graticule) {
                var lines = graticule().lines()
                    ...
                    .filter(function (line) {
                        return Math.abs(line.coordinates[0][0] % 90) > ε;
                    });
                lines.forEach(function (line) {
                    assert.deepEqual(_.extent(line.coordinates, function (p) {
                        return p[1];
                    }), [-80 - ε, +80 + ε]);
                });
            },
        ...
        "returns a MultiLineString of all lines": function (graticule) {
            ...
            assert.deepEqual(g(), {
                ...
                coordinates: g.lines().map(function (line) {
