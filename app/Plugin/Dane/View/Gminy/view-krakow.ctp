		...
		<div class="block">
            ...
            <ul class="dataHighlights side">
	            ...
	            <li class="dataHighlight">
	            	<a target="_blank" href="https://www.bip.krakow.pl/"><span class="glyphicon glyphicon-link"></span>Oficjalny BIP Krakowa<span class="glyphicon glyphicon-chevron-right"></a>
	            </li>
...
<div class="block">
	...
	<div class="content less-bottom-padding">
		...
		<div class="row separator-bottom">
			<div class="col-md-12">
				...
				<div class="pk-funkcje">							
					<p>Rada składa się z <a href="/dane/gminy/903,krakow/radni">43 radnych</a>, wybieranych w wyborach powszechnych.</p>
				</div>
				...
				<div class="pk-radni">
					...
					<ul>
						...
						<li><a title="<?= $radny['imiona'] . ' ' . $radny['nazwisko'] ?>" href="/dane/gminy/903/radni/<?= $radny['id'] ?>"><img src="http://resources.sejmometr.pl/avatars/3/<?= $radny['avatar_id'] ?>.jpg" /></a></li>
						<? } ?>
					</ul>
					<? } ?>
				</div>
		...
		<div class="row">
			<div class="col-md-4">
				...
				<div class="text-center">
					<img style="width: 100%;" src="http://img.youtube.com/vi/AR9UYwp7PQA/mqdefault.jpg" />
				</div>
		...
		<p class="text-center">
			<a class="btn btn-primary btn-sm" href="/dane/gminy/903,Krakow/rada">Dowiedz się więcej o radzie &raquo;</a>
		</p>
...
<div class="block">
    ...
    <div class="content less-bottom-padding">
	    	...
	    	<div class="col-md-4">
		    	...
		    	<div class="row">
		    		<div class="col-md-6">
				    	...
				    	<a href="/dane/gminy/903,krakow/urzad"><img style="width: 100%;" src="/dane/img/pk-prezydent.jpg"></a>
        ...
        <p class="text-center">
			<a class="btn btn-primary btn-sm" href="/dane/gminy/903,Krakow/urzad">Dowiedz się więcej o urzędzie &raquo;</a>
		</p>
