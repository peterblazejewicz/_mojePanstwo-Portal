                        ...
                        <? foreach ($controlls as $controll) { ?>
                            ...
                            <? } elseif ($controll == 'sortings') { ?>
                                ...
                                <? if (!empty($orders)) { ?>
                                    ...
                                    <div class="btn-group">
                                        <button class="dataSortingToggle dropdown-toggle btn btn-default btn-sm"
                                                data-toggle="dropdown"><span class="glyphicon glyphicon-sort"></span>
                                            <span class="text">Sortowanie</span></button>
                                        <ul class="dataSortingMenu dropdown-menu" role="menu"></ul>
                                        <select style="display: none;" id="DatasetSort" class="form-control input-sm"
                                                name="order">
                                            <?
