		...
		<div class="content">
			<div class="textBlock">
				...
				<p>Licytacja odbędzie się na stronie <a target="_blank"
						...
						<a target="_blank" href="<?= $details['le_adres_opis'] ?>">dodatkowe informacje</a>)<? } ?>.</p>

				<? if ( $details['le_term_otw'] ) { ?><p>Termin otwarcia licytacji: <?= $details['le_term_otw'] ?>
					.</p><? } ?>
...
<? if (
	...
	<div class="block">
		...
		<div class="content">
			<div class="textBlock">
				<p>Oferty można składać do <b><?= $this->Czas->dataSlownie( $details['oferty_data_stop'] ) ?></b>, do
					godziny <b><?= $details['oferty_godz'] ?></b><? if ( @$details['oferty_miejsce'] ) { ?>, w:<? } ?>
				</p>
