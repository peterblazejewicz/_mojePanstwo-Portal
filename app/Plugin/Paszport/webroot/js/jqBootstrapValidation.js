            ...
            init: function (options) {
                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        //                                                  REQUIRED
                        // ---------------------------------------------------------
                        if ($this.attr("required") !== undefined || $this.attr("aria-required") !== undefined || $this.attr('data-required') != undefined) {
                                    ...
                                    $.each(
                                        ...
                                        function (i, validator) {
                                            if (settings.validatorTypes[validatorType].validate($this, value, validator)) {
                                                ...
                                                $this.parents('form').find('input[type="submit"], button[type="submit"]').addClass('block');
                                            } else {
                                                $this.parents('form').find('input[type="submit"], button[type="submit"]').removeClass('block');
                                            }
                                        }
                                    );
                                }
