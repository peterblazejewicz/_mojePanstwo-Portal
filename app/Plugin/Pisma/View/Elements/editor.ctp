                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <p class="desc">Adresat pisma nie zobaczy powyższego tytułu. Będzie on używany tylko do
                                    organizacji Twoich pism.</p>
                            </div>
                        </div>
                    </fieldset>
                </div>
                ...
                <div class="col-md-2">
                    <div class="editor-tooltip">
                        ...
                        <ul class="form-buttons">
                            <li class="inner-addon"><i class="glyphicon glyphicon-send"></i><input type="submit"
                                                                                                   name="send"
                                                                                                   value="Zapisz i wyślij"
                                                                                                   class="btn btn-primary"/>
                            </li>
                            <li class="inner-addon"><i class="glyphicon glyphicon-saved"></i><input type="submit"
                                                                                                    name="save"
                                                                                                    value="Zapisz"
                                                                                                    class="btn btn-primary"/>
                            </li>
                            <li class="inner-addon"><i class="glyphicon glyphicon-print"></i><input type="submit"
                                                                                                    name="print"
                                                                                                    value="Wydrukuj"
                                                                                                    class="btn btn-primary"/>
                            </li>
