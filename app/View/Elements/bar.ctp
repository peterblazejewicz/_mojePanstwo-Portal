    ...
    <div class="_mPBasic">
        ...
        <div class="_mPApplication">
            <div class="_mPSearch _appBlock _appBlockBackground">
                <div class="_mPTitle"><i class="_mPAppIcon"
                                         data-icon-new="&#xe802;"></i><?php echo __('LC_COCKPITBAR_USER_SEARCH'); ?>
                </div>
            </div>
            <div class="_mPAppsList _appBlock _appBlockBackground">
                <div class="_mPTitle"><i class="_mPAppIcon"
                                         data-icon-new="&#xe800;"></i><?php echo __('LC_COCKPITBAR_USER_APPLICATION'); ?>
                </div>
            </div>
            <div class="_mPFavorite _appBlock _appBlockBackground">
                <div class="_mPTitle"><i class="_mPAppIcon"
                                         data-icon-new="&#xe803;"></i><?php echo __('LC_COCKPITBAR_USER_FAVOURITE'); ?>
                </div>
            </div>
        </div>
        <div class="_mPSystem">
