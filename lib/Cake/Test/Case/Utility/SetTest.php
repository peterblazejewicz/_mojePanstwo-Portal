...
class SetTest extends CakeTestCase {
	...
	public function testNumericKeyExtraction() {
		...
		$this->assertEquals( array(
			...
			'controller' => '',
			'action'     => ''
		), Set::diff( $data, Set::extract( $data, '{n}' ) ) );
	}
	...
	public function testExtractWithArrays() {
		...
		), Set::extract( '/Level1/Level2', $data ) );
		$this->assertEquals( array(
			array(
				'Level2bis' => array(
					'test3',
		...
		), Set::extract( '/Level1/Level2bis', $data ) );
	}
	...
	public function testCombine() {
		...
		$result   = Set::combine( $a, '{n}.User.id', array(
			'{0}: {1}',
			'{n}.User.Data.user',
			'{n}.User.Data.name'
		), '{n}.User.group_id' );
	...
	public function testPushDiff() {
		...
		$expected = array(
			0 => array(
				'ModelOne'   => array( 'id' => 1001, 'field_one' => 's1.0.m1.f1', 'field_two' => 's1.0.m1.f2' ),
