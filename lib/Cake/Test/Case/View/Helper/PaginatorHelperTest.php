...
class PaginatorHelperTest extends CakeTestCase {
	...
	public function testDisabledLink() {
		...
		$this->Paginator->request->params['paging']['Article']['prevPage'] = false;
		$result                                                            = $this->Paginator->prev( 'prev', array(
			'update'    => 'theList',
			'indicator' => 'loading',
			'url'       => array( 'controller' => 'posts' )
		), null, array( 'class' => 'disabled', 'tag' => 'span' ) );
		$expected                                                          = array(
	...
	public function testSortLinks() {
		...
		$result                                                                   = $this->Paginator->sort( 'title', array(
			'asc'  => 'ascending',
			'desc' => 'descending'
		) );
		$expected                                                                 = array(
		...
		$this->Paginator->request->params['paging']['Article']['options']['order'] = array( 'Article.title' => 'asc' );
		$this->Paginator->request->params['paging']['Article']['options']['sort']  = null;
		$result                                                                    = $this->Paginator->sort( 'title', 'Title', array(
			'direction' => 'desc',
			'class'     => 'foo'
		) );
	...
	public function testSortAdminLinks() {
		...
		Router::setRequestInfo( array(
			array(
				...
				'prefix'     => 'admin',
				'admin'      => true,
				'url'        => array( 'ext' => 'html', 'url' => 'admin/users' )
			),
	...
	public function testPassedArgsMergingWithUrlOptions() {
		...
		Router::setRequestInfo( array(
			array(
				...
				'pass'       => array( '2' ),
				'named'      => array( 'foo' => 'bar' ),
				'url'        => array( 'url' => 'articles/index/2/foo:bar' )
			),
		...
		$expected = array(
			array( 'span' => array( 'class' => 'current' ) ),
			'1',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/articles/index/2/page:2/foo:bar?x=y' ) ),
			'2',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/articles/index/2/page:3/foo:bar?x=y' ) ),
			'3',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/articles/index/2/page:4/foo:bar?x=y' ) ),
			'4',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/articles/index/2/page:5/foo:bar?x=y' ) ),
			'5',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/articles/index/2/page:6/foo:bar?x=y' ) ),
			'6',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/articles/index/2/page:7/foo:bar?x=y' ) ),
			'7',
			'/a',
			'/span',
		);
	...
	public function testPassedArgsMergingWithUrlOptionsParamTypeQuerystring() {
		...
		$expected = array(
			...
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/articles/index/2/foo:bar?x=y&amp;page=2' ) ),
			'2',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/articles/index/2/foo:bar?x=y&amp;page=3' ) ),
			'3',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/articles/index/2/foo:bar?x=y&amp;page=4' ) ),
			'4',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/articles/index/2/foo:bar?x=y&amp;page=5' ) ),
			'5',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/articles/index/2/foo:bar?x=y&amp;page=6' ) ),
			'6',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/articles/index/2/foo:bar?x=y&amp;page=7' ) ),
			'7',
			'/a',
			'/span',
		);
	...
	public function testGenericLinks() {
		$result   = $this->Paginator->link( 'Sort by title on page 5', array(
			'sort'      => 'title',
			'page'      => 5,
			'direction' => 'desc'
		) );
		...
		$this->Paginator->request->params['paging']['Article']['options']['page'] = 2;
		$result                                                                   = $this->Paginator->link( 'Sort by title', array(
			'sort'      => 'title',
			'direction' => 'desc'
		) );
		$expected                                                                 = array(
		...
		$result                                                                   = $this->Paginator->link( 'Sort by title on page 4', array(
			'sort'      => 'Article.title',
			'direction' => 'desc'
		) );
		$expected                                                                 = array(
	...
	public function testNumbers() {
		...
		$expected                                   = array(
			...
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:10' ) ),
			'10',
			'/a',
			'/span',
			' | ',
		...
		$expected = array(
			...
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:15', 'rel' => 'last' ) ),
			'last',
			'/a',
			'/span',
		);
		...
		$expected                                   = array(
			...
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:15' ) ),
			'15',
			'/a',
			'/span',
		);
		...
		$expected = array(
			array( 'span' => array( 'class' => 'page-link' ) ),
			array( 'a' => array( 'href' => '/' ) ),
			'1',
			'/a',
			'/span',
			' | ',
			array( 'span' => array( 'class' => 'current page-link' ) ),
			'2',
			'/span',
			' | ',
			array( 'span' => array( 'class' => 'page-link' ) ),
		...
		$expected = array(
			...
			'/span',
			' | ',
			array( 'span' => array( 'class' => 'active page-link' ) ),
			'2',
			'/span',
			' | ',
			array( 'span' => array( 'class' => 'page-link' ) ),
		...
		$expected = array(
			...
			'...',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:42' ) ),
			'42',
			'/a',
			'/span',
		);
		...
		$expected = array(
			...
			'...',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:33' ) ),
			'33',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:34' ) ),
			'34',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:35' ) ),
			'35',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:36' ) ),
			'36',
			'/a',
			'/span',
			' | ',
			...
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:38' ) ),
			'38',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:39' ) ),
			'39',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:40' ) ),
			'40',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:41' ) ),
			'41',
			'/a',
			'/span',
			' | ',
		...
		$expected                                   = array(
			array( 'span' => array( 'class' => 'page-link' ) ),
			array( 'a' => array( 'href' => '/index/sort:Client.name/direction:DESC' ) ),
			'1',
			'/a',
			'/span',
			' | ',
			...
			' | ',
			array( 'span' => array( 'class' => 'page-link' ) ),
			array( 'a' => array( 'href' => '/index/page:3/sort:Client.name/direction:DESC' ) ),
			'3',
			'/a',
			'/span',
			' | ',
			array( 'span' => array( 'class' => 'page-link' ) ),
			array( 'a' => array( 'href' => '/index/page:4/sort:Client.name/direction:DESC' ) ),
			'4',
			'/a',
			'/span',
		);
		...
		$expected = array(
			...
			'...',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:4894' ) ),
			'4894',
			'/a',
			'/span',
			' | ',
			...
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:4896' ) ),
			'4896',
			'/a',
			'/span',
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:4897' ) ),
			'4897',
			'/a',
			'/span',
		);
		...
		$expected = array(
			...
			'...',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:4893' ) ),
			'4893',
			'/a',
			'/span',
			' - ',
			...
			' - ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:4895' ) ),
			'4895',
			'/a',
			'/span',
			' - ',
		...
		$expected                                                     = array(
			...
			'...',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:4891' ) ),
			'4891',
			'/a',
			'/span',
			' - ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:4892' ) ),
			'4892',
			'/a',
			'/span',
			' - ',
		...
		$expected                                                     = array(
			...
			'...',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:56' ) ),
			'56',
			'/a',
			'/span',
			' - ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:57' ) ),
			'57',
			'/a',
			'/span',
			' - ',
			...
			' - ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:59' ) ),
			'59',
			'/a',
			'/span',
			' - ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:60' ) ),
			'60',
			'/a',
			'/span',
			'...',
		...
		$expected                                                     = array(
			...
			'/a',
			'/span',
			array( 'span' => array( 'class' => 'ellipsis' ) ),
			'...',
			'/span',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/index/page:4896' ) ),
		...
		$expected = array(
			...
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/clients/index/page:3' ) ),
			'3',
			'/a',
			'/span',
		...
		$expected = array(
			...
			' | ',
			array( 'span' => array() ),
			array( 'a' => array( 'href' => '/clients?page=3' ) ),
			'3',
			'/a',
			'/span',
	...
	public function testFirstFullBaseUrl() {
		...
		$expected = array(
			...
			array(
				'a' => array(
					'href' => FULL_BASE_URL . '/index/sort:Article.title/direction:DESC',
					'rel'  => 'first'
				)
			),
			'&lt;&lt; first',
	...
	public function testLastOptions() {
		...
		$expected = array(
			'...',
			'<span',
			array( 'a' => array( 'href' => '/index/page:15/sort:Client.name/direction:DESC' ) ),
			'15',
			'/a',
			'/span',
		);
		...
		$expected = array(
			'...',
			'<span',
			array( 'a' => array( 'href' => '/index/page:14/sort:Client.name/direction:DESC' ) ),
			'14',
			'/a',
			'/span',
			' | ',
	...
	public function testWithPlugin() {
		...
		$expected = array(
			'a' => array( 'href' => '/my_plugin/magazines/index/page:3' ),
			'Page 3',
			'/a'
		);
		$this->assertTags( $result, $expected );
		...
		$result   = $this->Paginator->link( 'Page 3', array( 'page' => 3 ) );
		$expected = array(
			'a' => array( 'href' => '/my_plugin/magazines/another_index/page:3' ),
			'Page 3',
			'/a'
		);
		$this->assertTags( $result, $expected );
		...
		$result   = $this->Paginator->link( 'Page 3', array( 'page' => 3 ) );
		$expected = array(
			'a' => array( 'href' => '/my_plugin/issues/index/page:3' ),
			'Page 3',
			'/a'
		);
		$this->assertTags( $result, $expected );
		...
		$result   = $this->Paginator->link( 'Page 3', array( 'page' => 3 ) );
		$expected = array(
			'a' => array( 'href' => '/magazines/index/page:3' ),
			'Page 3',
			'/a'
		);
		$this->assertTags( $result, $expected );
		...
		$result   = $this->Paginator->link( 'Page 3', array( 'page' => 3 ) );
		$expected = array(
			'a' => array( 'href' => '/issues/index/page:3' ),
			'Page 3',
			'/a'
		);
		$this->assertTags( $result, $expected );
