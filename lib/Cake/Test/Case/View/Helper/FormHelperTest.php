...
class FormHelperTest extends CakeTestCase {
	...
	public function testFormSecuredInput() {
		...
		$expected = array(
			...
			array(
				'input' => array(
					'type'  => 'hidden',
					'name'  => 'data[UserForm][something]',
					'value' => '0',
					'id'    => 'UserFormSomething_'
				)
			),
			array(
				'input' => array(
	...
	public function testMultipleInputValidation() {
		$Address                      = ClassRegistry::init( array(
			'class' => 'Address',
			'table' => false,
			'ds'    => 'test'
		) );
	...
	public function testInput() {
		...
		$expected                                                       = array(
			...
			'input' => array(
				'type'  => 'text',
				'name'  => 'data[Model][0][OtherModel][field]',
				'value' => 'My value',
				'id'    => 'myId'
			),
			'/div'
		...
		$result   = $this->Form->input( 'Contact.field', array(
			'div'   => array( 'tag' => 'span' ),
			'error' => array( 'attributes' => array( 'wrap' => false ) )
		) );
		$expected = array(
	...
	public function testInputSelectType() {
		$result   = $this->Form->input( 'email', array(
				'options' => array( 'è' => 'Firést', 'é' => 'Secoènd' ),
				'empty'   => true
			)
		);
		$expected = array(
	...
	public function testFormInputs() {
		...
		$result = $this->Form->inputs( null, null, array(
			'legend'   => 'Field of Dreams',
			'fieldset' => 'classy-stuff'
		) );
		$this->assertTags( $result, $expected );
	...
	public function testSelectAsCheckbox() {
		$result   = $this->Form->select( 'Model.multi_field', array(
			'first',
			'second',
			'third'
	...
	public function testLabel() {
		...
		$this->assertTags( $result, array(
			'label' => array( 'for' => 'PersonFirstName' ),
			'Your first name',
			'/label'
		) );
		...
		$this->assertTags( $result, array(
			'label' => array( 'for' => 'PersonFirstName', 'class' => 'my-class' ),
			'Your first name',
			'/label'
		) );

		$result = $this->Form->label( 'Person.first_name', 'Your first name', array(
			'class' => 'my-class',
			'id'    => 'LabelID'
		) );
		$this->assertTags( $result, array(
	...
	public function testError() {
		...
		$this->assertTags( $result, array(
			'span' => array( 'class' => 'error-message' ),
			'This field contains invalid input',
			'/span'
		) );
		...
		$result = $this->Form->error( 'Contact.field', "<strong>Badness!</strong>", array(
			'wrap'   => false,
			'escape' => true
		) );
		$this->assertEquals( '&lt;strong&gt;Badness!&lt;/strong&gt;', $result );
		...
		$result                             = $this->Form->error( 'Contact.field', array(
			'attributes' => array( 'class' => 'field-error' ),
			'email'      => 'No good!'
		) );
		$expected                           = array(
	...
	public function testRadio() {
		...
		$result   = $this->Form->radio( 'Model.field', array(
			'option A',
			'option B'
		), array( 'separator' => '<br/>' ) );
		$expected = array(
	...
	public function testSelect() {
		...
		$expected = array(
			...
			'pick something',
			'/option',
			array( 'option' => array( 'value' => '228', 'selected' => 'selected' ) ),
			'228 value',
			'/option',
			array( 'option' => array( 'value' => '228-1' ) ),
			'228-1 value',
			'/option',
			array( 'option' => array( 'value' => '228-2' ) ),
			'228-2 value',
			'/option',
			'/select'
		);
	...
	public function testSelectMultipleWithDisabledElements() {
		$options  = array( 1 => 'One', 2 => 'Two', '3' => 'Three', '3x' => 'Stringy' );
		$disabled = array( 2, 3 );
		$result   = $this->Form->select( 'Contact.multiple', $options, array(
			'multiple' => 'multiple',
			'disabled' => $disabled
		) );
		$expected = array(
	...
	public function testHabtmSelectBox() {
		...
		$expected = array(
			'input'  => array(
				'type'  => 'hidden',
				'name'  => 'data[ContactTag][ContactTag]',
				'value' => '',
				'id'    => 'ContactTagContactTag_'
			),
			'select' => array(
				'name'     => 'data[ContactTag][ContactTag][]',
				'id'       => 'ContactTagContactTag',
				'multiple' => 'multiple'
			),
			array( 'option' => array( 'value' => '1', 'selected' => 'selected' ) ),
			'blue',
	...
	public function testSelectMultipleCheckboxDiv() {
		...
		$expected = array(
			...
			array( 'label' => array( 'for' => 'ModelTags1' ) ),
			'second',
			'/label',
			'/div'
		);
	...
	public function testSelectCheckboxMultipleOverrideName() {
		...
		$expected = array(
			...
			array( 'label' => array( 'for' => 'Category0' ) ),
			'1',
			'/label',
			'/div',
			array( 'div' => array( 'class' => 'checkbox' ) ),
			...
			array( 'label' => array( 'for' => 'Category1' ) ),
			'2',
			'/label',
			'/div'
		);
	...
	public function testCheckbox() {
		...
		$result                                        = $this->Form->checkbox( 'Contact.field', array(
			'id'    => 'theID',
			'value' => 'myvalue'
		) );
		$expected                                      = array(
		...
		$expected = array(
			'input' => array(
				'type'  => 'hidden',
				'name'  => 'data[Model][CustomField][1][value]',
				'value' => '0',
				'id'    => 'ModelCustomField1Value_'
			),
			array(
				'input' => array(
					'type'  => 'checkbox',
		...
		$expected = array(
			'input' => array(
				'type'  => 'hidden',
				'name'  => 'data[CustomField][1][value]',
				'value' => '0',
				'id'    => 'CustomField1Value_'
			),
			array(
				'input' => array(
					'type'  => 'checkbox',
	...
	public function testDateTime() {
		...
		$expected = array(
			...
			array(
				'select' => array(
					'name' => 'data[Contact][published2][month]',
					'id'   => 'ContactPublished2Month'
				)
			),
			$monthsRegex,
			array( 'option' => array( 'value' => date( 'm', $now ), 'selected' => 'selected' ) ),
	...
	public function testFormDateTimeMulti() {
		...
		$expected = array(
			...
			array(
				'select' => array(
					'name' => 'data[Contact][1][updated][meridian]',
					'id'   => 'Contact1UpdatedMeridian'
				)
			),
			$meridianRegex,
			array( 'option' => array( 'value' => '' ) ),
		...
		$expected = array(
			...
			array(
				'select' => array(
					'name' => 'data[Contact][2][updated][meridian]',
					'id'   => 'Contact2UpdatedMeridian'
				)
			),
			$meridianRegex,
			array( 'option' => array( 'value' => '' ) ),
	...
	public function testYear() {
		...
		$expected                                    = array(
			array(
				'select' => array(
					'name'  => 'data[Contact][published][year]',
					'id'    => 'ContactPublishedYear',
					'class' => 'year'
				)
			),
			array( 'option' => array( 'value' => '' ) ),
		...
		$this->Form->request->data['Contact']['published'] = '2006-10-10';
		$result                                            = $this->Form->year( 'Contact.published', 2006, 2007, array(
			'empty' => false,
			'value' => false
		) );
		$expected                                          = array(
		...
		$this->Form->request->data['Contact']['published'] = '';
		$result                                            = $this->Form->year( 'Contact.published', 2006, 2008, array(
			'empty' => false,
			'value' => 2007
		) );
		$expected                                          = array(
	...
	public function testFileUploadField() {
		...
		$this->assertTags( $result, array(
			'input' => array(
				'type' => 'file',
				'name' => 'data[Model][upload]',
				'id'   => 'ModelUpload'
			)
		) );

		$this->Form->request->data['Model.upload'] = array(
			"name"     => "",
			"type"     => "",
			"tmp_name" => "",
			"error"    => 4,
	...
	public function testButton() {
		...
		$this->assertTags( $result, array(
			'button' => array( 'type' => 'reset', 'id' => 'clearForm' ),
			'Clear Form >',
			'/button'
		) );
	...
	public function testPostLink() {
		...
		$this->assertTags( $result, array(
			...
			'a'     => array(
				'href'    => '#',
				'onclick' => 'preg:/document\.post_\w+\.submit\(\); event\.returnValue = false; return false;/'
			),
			'Delete',
			'/a'
		) );
		...
		$this->assertTags( $result, array(
			...
			'a'     => array(
				'href'    => '#',
				'onclick' => 'preg:/if \(confirm\(&quot;Confirm\?&quot;\)\) \{ document\.post_\w+\.submit\(\); \} event\.returnValue = false; return false;/'
			),
			'Delete',
			'/a'
		) );
		...
		$this->assertTags( $result, array(
			...
			'a'     => array(
				'href'    => '#',
				'onclick' => 'preg:/if \(confirm\(&quot;&#039;Confirm&#039; this \\\\&quot;deletion\\\\&quot;\?&quot;\)\) \{ document\.post_\w+\.submit\(\); \} event\.returnValue = false; return false;/'
			),
			'Delete',
			'/a'
		) );
		...
		$this->assertTags( $result, array(
			...
			'a'     => array(
				...
				'href'    => '#',
				'onclick' => 'preg:/if \(confirm\(\&quot\;Confirm thing\&quot\;\)\) \{ document\.post_\w+\.submit\(\); \} event\.returnValue = false; return false;/'
			),
			'/a'
		) );
	}
	...
	public function testCreate() {
		...
		$expected                                                = array(
			'form'  => array(
				'id'             => 'ContactNonStandardPkEditForm',
				'method'         => 'post',
	...
	public function testCreateAutoUrl() {
		...
		$expected                  = array(
			'form'  => array(
				'id'             => 'ContactAddForm',
				'method'         => 'post',
				'action'         => '/base_url/contacts/add/Contact:1',
				'accept-charset' => 'utf-8'
			),
			'div'   => array( 'style' => 'display:none;' ),
			'input' => array( 'type' => 'hidden', 'name' => '_method', 'value' => 'POST' ),
		...
		$expected                      = array(
			'form'  => array(
				...
				'method'         => 'post',
				'action'         => '/base_url/contacts/delete/10/User:42',
				'accept-charset' => 'utf-8'
			),
			'div'   => array( 'style' => 'display:none;' ),
			'input' => array( 'type' => 'hidden', 'name' => '_method', 'value' => 'POST' ),
	...
	public function testCreateWithInputDefaults() {
		...
		$result   = $this->Form->input( 'username', array(
			'label'  => 'Username',
		...
		$expected = array(
			'div'   => array( 'class' => 'input text' ),
			'label' => array( 'for' => 'changed', 'class' => 'nice' ),
			'Username',
			'/label',
			'input' => array( 'type' => 'text', 'name' => 'data[User][username]', 'id' => 'UserUsername' ),
			'/div'
	...
	public function testGetFormWithFalseModel() {
		...
		$result                            = $this->Form->create( false, array(
			'type' => 'get',
			'url'  => array( 'controller' => 'contact_test' )
		) );
	...
	public function testFormInputRequiredDetection() {
		...
		$expected = array(
			...
			'input' => array(
				'type' => 'text',
				'name' => 'data[Contact][non_existing]',
		...
		$expected = array(
			...
			'input' => array(
				'type'     => 'text',
				'name'     => 'data[Contact][imalsorequired]',
		...
		$expected = array(
			...
			'input' => array(
				'type'     => 'text',
				'name'     => 'data[Contact][imrequiredtoo]',
		...
		$expected = array(
			...
			'input' => array(
				'type'     => 'text',
				'name'     => 'data[Contact][string_required]',
		...
		$expected = array(
			...
			'input' => array(
				'type' => 'text',
				'name' => 'data[Contact][imnotrequired]',
		...
		$expected = array(
			...
			'input' => array(
				'type' => 'text',
				'name' => 'data[Contact][imalsonotrequired]',
		...
		$expected = array(
			...
			'input' => array(
				'type' => 'text',
				'name' => 'data[Contact][imalsonotrequired2]',
		...
		$expected = array(
			...
			'input' => array(
				'type' => 'text',
				'name' => 'data[Contact][imnotrequiredeither]',
	...
	public function testFormMagicInput() {
		...
		$expected = array(
			...
			'input' => array(
				'type' => 'text',
				'name' => 'data[Contact][non_existing_field_in_contact_model]',
		...
		$expected = array(
			...
			'input' => array(
				'type' => 'text',
				'name' => 'data[Address][non_existing_field_in_model]',
		...
		$expected = array(
			...
			array(
				'select' => array(
					'name' => 'data[Contact][published][month]',
					'id'   => 'ContactPublishedMonth'
				)
			),
			$monthsRegex,
			array( 'option' => array( 'value' => date( 'm', $now ), 'selected' => 'selected' ) ),
			...
			array(
				'select' => array(
					'name' => 'data[Contact][published][day]',
					'id'   => 'ContactPublishedDay'
				)
			),
			$daysRegex,
			array( 'option' => array( 'value' => date( 'd', $now ), 'selected' => 'selected' ) ),
		...
		$expected = array(
			...
			array(
				'select' => array(
					'name' => 'data[Contact][updated][month]',
					'id'   => 'ContactUpdatedMonth'
				)
			),
			$monthsRegex,
			array( 'option' => array( 'value' => date( 'm', $now ), 'selected' => 'selected' ) ),
			...
			array(
				'select' => array(
					'name' => 'data[Contact][updated][day]',
					'id'   => 'ContactUpdatedDay'
				)
			),
			$daysRegex,
			array( 'option' => array( 'value' => date( 'd', $now ), 'selected' => 'selected' ) ),
			...
			array(
				'select' => array(
					'name' => 'data[Contact][updated][year]',
					'id'   => 'ContactUpdatedYear'
				)
			),
			$yearsRegex,
			array( 'option' => array( 'value' => date( 'Y', $now ), 'selected' => 'selected' ) ),
	...
	public function testForMagicInputNonExistingNorValidated() {
		...
		$expected = array(
			...
			'input' => array(
				'type' => 'text',
				'name' => 'data[Contact][non_existing_nor_validated]',
		...
		$this->Form->request->data = array(
			'Contact' => array(
				'non_existing_nor_validated' => 'CakePHP magic'
			)
		);
		$result                    = $this->Form->input( 'Contact.non_existing_nor_validated', array( 'div' => false ) );
		$expected                  = array(
	...
	public function testInputTemplate() {
		...
		$result   = $this->Form->input( 'Contact.email', array(
			'type'    => 'text',
			'format'  => array( 'input', 'between', 'label', 'after' ),
	...
	public function testRequiredOnCreate() {
		...
		$expected = array(
			...
			'input' => array(
				'type' => 'text',
				'name' => 'data[Contact][imrequiredonupdate]',
		...
		$expected = array(
			...
			'input' => array(
				'type'     => 'text',
				'name'     => 'data[Contact][imrequiredoncreate]',
		...
		$expected = array(
			...
			'input' => array(
				'type'     => 'text',
				'name'     => 'data[Contact][imrequiredonboth]',
