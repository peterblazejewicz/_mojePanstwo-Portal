...
class MysqlTest extends CakeTestCase {
	...
	public function testIndexDetection() {
		...
		$expected = array(
			'PRIMARY'    => array( 'column' => 'id', 'unique' => 1 ),
			'text_index' => array(
				'column' => array( 'text_field1', 'text_field2' ),
				'unique' => 0,
				'length' => array( 'text_field1' => 20, 'text_field2' => 20 )
			),
		);
	...
	public function testArrayConditionsParsing() {
		...
		$result   = $this->Dbo->conditions( array(
			'published' => 1,
			'or'        => array( 'score >' => '2', array( 'score >' => '20' ) )
		) );
		...
		$result = $this->Dbo->conditions( array(
				'NOT'                        => array(
					'Course.id'             => null,
					'Course.vet'            => 'N',
					'level_of_education_id' => array( 912, 999 )
				),
	...
	public function testRealQueries() {
		...
		$expected = array(
			$this->Dbo->fullTableName( 'apples', false, false ) => array(
				'color' => 'Red 1',
				'name'  => 'Red Apple 1'
			)
		);
