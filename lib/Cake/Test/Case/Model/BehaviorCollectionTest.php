...
class BehaviorCollectionTest extends CakeTestCase {
	...
	public function testBehaviorBinding() {
		...
		$this->assertEquals( array(
			...
			'afterFind'  => 'off',
			'key2'       => 'value2'
		), $Apple->Sample->Behaviors->Test->settings['Sample'] );
		...
		$this->assertEquals( array(
			...
			'key2'       => 'value2',
			'key3'       => 'value3'
		), $Apple->Behaviors->Test->settings['Apple'] );
		...
		$Apple->Child->Behaviors->load( 'Test', array(
			'key'        => 'value',
			'key2'       => 'value2',
			'key3'       => 'value3',
			'beforeFind' => 'off'
		...
		$Apple->Parent->Behaviors->load( 'Test', array(
			'key'        => 'value',
			'key2'       => 'value2',
			'key3'       => 'value3',
			'beforeFind' => 'off'
