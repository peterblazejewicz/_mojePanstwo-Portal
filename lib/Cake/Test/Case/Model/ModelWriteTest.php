...
class ModelWriteTest extends BaseModelTest {
		...
		$result = $TestModel->saveAll( array(
			...
			'Comment' => array(
				...
				array(
					...
					'published'  => 'Y',
					'user_id'    => 2,
					'Attachment' => array( 'attachment' => 'deepsaved' )
				)
			)
		), array( 'deep' => true ) );
		$this->assertTrue( $result );
	...
	public function testSaveAllDeepMany() {
		...
		$data   = array(
			array(
				...
				'Comment' => array(
					array(
						'comment'   => 'First comment deepsaved article 1',
						'published' => 'Y',
						'User'      => array( 'user' => 'savemany', 'password' => 'manysaved' )
					),
			...
			array(
				...
				'Comment' => array(
					array(
						'comment'   => 'First comment deepsaved article 2',
						'published' => 'Y',
						'User'      => array( 'user' => 'savemore', 'password' => 'moresaved' )
					),
			...
			array(
				...
				'Comment' => array(
					array(
						'comment'   => '',
						'published' => 'Y',
						'User'      => array( 'user' => '', 'password' => 'manysaved' )
					),
					array( 'comment' => 'Second comment deepsaved article 1', 'published' => 'Y', 'user_id' => 2 )
				)
			),
			array(
				...
				'Comment' => array(
					array(
						'comment'   => 'First comment deepsaved article 2',
						'published' => 'Y',
						'User'      => array( 'user' => 'savemore', 'password' => '' )
					),
	...
	public function testSaveAllDeepValidateOnly() {
			...
			array(
				...
				'Comment' => array(
					array(
						'comment'   => 'First new comment',
						'published' => 'Y',
						'User'      => array( 'user' => '', 'password' => 'newuserpass' )
					),
					array( 'comment' => 'Second new comment', 'published' => 'Y', 'user_id' => 2 )
				)
			),
		...
		$result   = $TestModel->saveAll( array(
				...
				'Comment' => array(
					...
					array(
						...
						'published'  => 'Y',
						'user_id'    => 2,
						'Attachment' => array( 'attachment' => 'deepsave' )
					)
				)
			),
			array( 'validate' => 'only', 'atomic' => false, 'deep' => true )
		...
		$result   = $TestModel->Comment->Attachment->saveAll( $data, array(
			'validate' => 'only',
			'atomic'   => false,
			'deep'     => true
		) );
	...
	public function testSaveAssociatedHasManyEmpty() {
		...
		$TestModel            = new Article();
		$TestModel->belongsTo = $TestModel->hasAndBelongsToMany = array();
		$TestModel->validate  = $TestModel->Comment->validate = array(
			'user_id' => array(
				'notEmpty' => array(
					'rule'     => 'notEmpty',
					'required' => true
		...
		$result = $TestModel->saveAssociated( array( 'Article' => array() ), array(
			'validate' => true,
			'atomic'   => false
		) );
		$this->assertEquals( array( 'Article' => false ), $result );
	...
	public function testSaveManyTransactionNoRollback() {
		...
		$this->getMock( 'DboSource', array(
			'connect',
			'rollback',
			'describe'
		), array(), 'MockManyTransactionDboSource' );
