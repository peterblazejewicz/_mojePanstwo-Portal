...
class TreeBehaviorScopedTest extends CakeTestCase {
	...
	public function testStringScope() {
		...
		$result   = $this->Tree->children();
		$expected = array( array( 'FlagTree' => array( 'id'        => '2',
		                                               'name'      => '1.1',
		                                               'parent_id' => '1',
		                                               'lft'       => '2',
		                                               'rght'      => '9',
	...
	public function testRecoverUsingParentMode() {
		...
		$this->Tree->create();
		$this->Tree->save( array( 'name'       => 'Main',
		                          $parentField => null,
		                          $leftField   => 0,
		                          $rightField  => 0,
		                          'flag'       => 1
		...
		$this->Tree->create();
		$this->Tree->save( array( 'name'       => 'About Us',
		                          $parentField => $node1,
		                          $leftField   => 0,
		                          $rightField  => 0,
		                          'flag'       => 1
		...
		$this->Tree->create();
		$this->Tree->save( array( 'name'       => 'Programs',
		                          $parentField => $node1,
		                          $leftField   => 0,
		                          $rightField  => 0,
		                          'flag'       => 1
		...
		$this->Tree->create();
		$this->Tree->save( array( 'name'       => 'Mission and History',
		                          $parentField => $node11,
		                          $leftField   => 0,
		                          $rightField  => 0,
		                          'flag'       => 1
		...
		$this->Tree->create();
		$this->Tree->save( array( 'name'       => 'Overview',
		                          $parentField => $node12,
		                          $leftField   => 0,
		                          $rightField  => 0,
		                          'flag'       => 1
