	...
	public function getOptionParser() {
		...
		$parser->description(
			...
			'parser' => array(
				...
				'arguments'   => array(
					'aro'    => array(
						'help'     => __d( 'cake_console', 'ARO to grant permission to.' ),
						'required' => true
					),
			...
			'parser' => array(
				...
				'arguments'   => array(
					'aro'    => array(
						'help'     => __d( 'cake_console', 'ARO to have permissions inherit.' ),
						'required' => true
					),
					'aco'    => array(
						'help'     => __d( 'cake_console', 'ACO to inherit permissions on.' ),
						'required' => true
					),
